import { g as sn, m as an, n as C, j as Gn, o as W, q as Un, r as Xe, t as Fn, u as Nt, v as xe, w as Rn, M as Wn, x as Qn, y as Hn, z as Zn } from "./en_US-FEVFXARA-Bt5B3GiI.js";
import { E as Yn } from "./events-CnywZz7I.js";
import { L as Xn, l as Ct } from "./index-Chfa4EHr.js";
import { s as Et } from "./index-PEflfust.js";
import { l as O, b as Ce, y as Lt, g as Dt, H as rt, B as Kn, q as gt, a as Ke, F as Jn, _ as xt, A as qn } from "./hooks.module-DEHxprTa.js";
import { h as kt, y as Vn } from "./index.modern-DD62KDHh.js";
import { Q as Bt, U as _n } from "./index.es-SooumTx_.js";
var cn = { exports: {} };
(function(e) {
  ...
  function o(u, s, c, d, p) {
    if (typeof c != "function")
      throw new TypeError("The listener must be a function");
    var g = new r(c, d || u, p), w = n ? n + s : s;
    return u._events[w] ? u._events[w].fn ? u._events[w] = [u._events[w], g] : u._events[w].push(g) : (u._events[w] = g, u._eventsCount++), u;
  }
  function a(u, s) {
    --u._eventsCount === 0 ? u._events = new i() : delete u._events[s];
  }
  function l() {
  ...
  l.prototype.eventNames = function() {
    ...
    for (d in c = this._events)
      t.call(c, d) && s.push(n ? d.slice(1) : d);
    return Object.getOwnPropertySymbols ? s.concat(Object.getOwnPropertySymbols(c)) : s;
  }, l.prototype.listeners = function(s) {
    var c = n ? n + s : s, d = this._events[c];
    if (!d) return [];
    if (d.fn) return [d.fn];
    for (var p = 0, g = d.length, w = new Array(g); p < g; p++)
      w[p] = d[p].fn;
    return w;
  }, l.prototype.listenerCount = function(s) {
    var c = n ? n + s : s, d = this._events[c];
    return d ? d.fn ? 1 : d.length : 0;
  }, l.prototype.emit = function(s, c, d, p, g, w) {
    var v = n ? n + s : s;
    if (!this._events[v]) return !1;
    var f = this._events[v], y = arguments.length, D, I;
    if (f.fn) {
      switch (f.once && this.removeListener(s, f.fn, void 0, !0), y) {
        case 1:
        ...
        case 4:
          return f.fn.call(f.context, c, d, p), !0;
        case 5:
          return f.fn.call(f.context, c, d, p, g), !0;
        case 6:
          return f.fn.call(f.context, c, d, p, g, w), !0;
      }
      for (I = 1, D = new Array(y - 1); I < y; I++)
        D[I - 1] = arguments[I];
      f.fn.apply(f.context, D);
    } else {
      var Ie = f.length, z;
      for (I = 0; I < Ie; I++)
        switch (f[I].once && this.removeListener(s, f[I].fn, void 0, !0), y) {
          case 1:
          ...
          case 2:
            ...
            break;
          case 3:
            f[I].fn.call(f[I].context, c, d);
            break;
          case 4:
            f[I].fn.call(f[I].context, c, d, p);
            break;
          default:
            if (!D) for (z = 1, D = new Array(y - 1); z < y; z++)
              D[z - 1] = arguments[z];
            f[I].fn.apply(f[I].context, D);
        }
    }
    return !0;
  }, l.prototype.on = function(s, c, d) {
    return o(this, s, c, d, !1);
  }, l.prototype.once = function(s, c, d) {
    return o(this, s, c, d, !0);
  }, l.prototype.removeListener = function(s, c, d, p) {
    var g = n ? n + s : s;
    ...
    if (w.fn)
      w.fn === c && (!p || w.once) && (!d || w.context === d) && a(this, g);
    else {
      for (var v = 0, f = [], y = w.length; v < y; v++)
        (w[v].fn !== c || p && !w[v].once || d && w[v].context !== d) && f.push(w[v]);
      f.length ? this._events[g] = f.length === 1 ? f[0] : f : a(this, g);
    }
    return this;
  }, l.prototype.removeAllListeners = function(s) {
    var c;
    return s ? (c = n ? n + s : s, this._events[c] && a(this, c)) : (this._events = new i(), this._eventsCount = 0), this;
...
var $n = cn.exports;
const ei = /* @__PURE__ */ sn($n);
var L;
(function(e) {
  e.Loading = "Loading", e.NotFound = "NotFound", e.Found = "Found";
})(L || (L = {}));
var m;
(function(e) {
  e.Loading = "Loading", e.NotFound = "NotFound", e.Disconnect = "Disconnected", e.Connected = "Connected";
})(m || (m = {}));
class Ze extends ei {
  get connected() {
    return this.state === m.Connected;
  }
  /**
...
class de extends V {
  constructor() {
    super(...arguments), this.name = "WalletNotFoundError", this.message = "The wallet is not found.";
  }
}
class U extends V {
  constructor() {
    super(...arguments), this.name = "WalletDisconnectedError", this.message = "The wallet is disconnected. Please connect first.";
  }
}
class X extends V {
  constructor() {
...
class ti extends V {
  constructor() {
    super(...arguments), this.name = "WalletWindowClosedError", this.message = "The QR window is closed.";
  }
}
class jt extends V {
  constructor() {
...
var we;
(function(e) {
  e.Mainnet = "Mainnet", e.Shasta = "Shasta", e.Nile = "Nile", e.Unknown = "Unknown";
})(we || (we = {}));
var ot;
(function(e) {
  e.Mainnet = "Mainnet", e.Shasta = "Shasta", e.Nile = "Nile";
})(ot || (ot = {}));
function ne() {
  return typeof window < "u" && typeof document < "u" && typeof navigator < "u";
}
function ce() {
...
var ni = function(e, t, n, i) {
  ...
  return new (n || (n = Promise))(function(o, a) {
    ...
    function s(c) {
      c.done ? o(c.value) : r(c.value).then(l, u);
    }
...
function un() {
  return !!(st() || window.tronLink || window.tronWeb);
}
function ii() {
  return ne() && typeof window.iTron < "u";
}
function ri({ dappIcon: e, dappName: t } = { dappIcon: "", dappName: "" }) {
  if (!un() && ce() && !ii()) {
    let n = "", i = "";
    try {
      n = document.title;
      const c = document.querySelector('link[rel*="icon"]');
      c && (i = new URL(c.getAttribute("href") || "", location.href).toString());
    } catch {
    }
    const { origin: r, pathname: o, search: a, hash: l } = window.location, u = r + o + a + (l.includes("?") ? l : `${l}?_=1`), s = {
      action: "open",
      actionId: Date.now() + "",
    ...
    return window.location.href = `tronlinkoutside://pull.activity?param=${encodeURIComponent(JSON.stringify(s))}`, !0;
  }
  return !1;
}
function oi(e) {
  return ni(this, void 0, void 0, function* () {
    return new Promise((t, n) => {
      const i = setInterval(() => {
        e.tronWeb && (clearInterval(i), clearTimeout(r), t());
      }, 50), r = setTimeout(() => {
        clearInterval(i), n("`window.tron.tronweb` is not ready.");
      }, 2e3);
    });
  });
}
...
const si = {
  "0x2b6653dc": we.Mainnet,
  "0x94a9059e": we.Shasta,
  "0xcd8690dc": we.Nile
};
function hn(e) {
  var t, n, i;
  return Y(this, void 0, void 0, function* () {
    const { blockID: r = "" } = yield e.trx.getBlockByNumber(0), o = `0x${r.slice(-8)}`;
    return {
      networkType: si[o] || we.Unknown,
      chainId: o,
      fullNode: ((t = e.fullNode) === null || t === void 0 ? void 0 : t.host) || "",
      solidityNode: ((n = e.solidityNode) === null || n === void 0 ? void 0 : n.host) || "",
      eventServer: ((i = e.eventServer) === null || i === void 0 ? void 0 : i.host) || ""
    };
  });
}
const ai = "TronLink";
class ci extends Ze {
  ...
  constructor(t = {}) {
    ...
    if (this.config = {
      ...
      dappIcon: i,
      dappName: r
    }, this._connecting = !1, this._wallet = null, this._address = null, !ne()) {
      this._readyState = L.NotFound, this.setState(m.NotFound);
      return;
    }
    st() || ce() && (window.tronLink || window.tronWeb) ? (this._readyState = L.Found, this._updateWallet()) : this._checkWallet().then(() => {
  ...
  network() {
    ...
    return Y(this, void 0, void 0, function* () {
      try {
        if (yield this._checkWallet(), this.state !== m.Connected)
          throw new U();
        const n = ((t = this._wallet) === null || t === void 0 ? void 0 : t.tronWeb) || window.tronWeb;
        if (!n)
          throw new U();
        try {
          return yield hn(n);
        } catch (i) {
          throw new dn(i == null ? void 0 : i.message, i);
        }
      } catch (n) {
    ...
    return Y(this, void 0, void 0, function* () {
      try {
        if (this.checkIfOpenTronLink(), this.connected || this.connecting)
          return;
        if (yield this._checkWallet(), this.state === m.NotFound)
          throw this.config.openUrlWhenWalletNotFound !== !1 && ne() && window.open(this.url, "_blank"), new de();
        if (!this._wallet)
          return;
        if (this._connecting = !0, this._supportNewTronProtocol) {
          const i = this._wallet;
          try {
            const o = (yield i.request({ method: "eth_requestAccounts" }))[0];
            this.setAddress(o), this.setState(m.Connected), this._listenTronEvent(), this._wallet.tronWeb || (yield oi(this._wallet));
          } catch (r) {
            let o = (r == null ? void 0 : r.message) || r || "Connect TronLink wallet failed.";
            throw r.code === -32002 && (o = "The same DApp has already initiated a request to connect to TronLink wallet, and the pop-up window has not been closed."), r.code === 4001 && (o = "The user rejected connection."), new X(o, r);
          }
        } else if (window.tronLink) {
          const i = this._wallet;
          try {
            const o = yield i.request({ method: "tron_requestAccounts" });
            if (!o)
              throw new X("TronLink wallet is locked or no wallet account is avaliable.");
            if (o.code === 4e3)
              throw new X("The same DApp has already initiated a request to connect to TronLink wallet, and the pop-up window has not been closed.");
            if (o.code === 4001)
              throw new X("The user rejected connection.");
          } catch (o) {
            throw new X(o == null ? void 0 : o.message, o);
          }
          const r = ((t = i.tronWeb.defaultAddress) === null || t === void 0 ? void 0 : t.base58) || "";
          this.setAddress(r), this.setState(m.Connected), this._listenTronLinkEvent();
        } else if (window.tronWeb) {
          const r = ((n = this._wallet.tronWeb.defaultAddress) === null || n === void 0 ? void 0 : n.base58) || "";
          this.setAddress(r), this.setState(m.Connected);
        } else
          throw new X("Cannot connect wallet.");
        this.connected && this.emit("connect", this.address || "");
      } catch (i) {
  ...
  disconnect() {
    return Y(this, void 0, void 0, function* () {
      this._supportNewTronProtocol ? this._stopListenTronEvent() : this._stopListenTronLinkEvent(), this.state === m.Connected && (this.setAddress(null), this.setState(m.Disconnect), this.emit("disconnect"));
    });
  }
  signTransaction(t, n) {
    return Y(this, void 0, void 0, function* () {
      try {
        const i = yield this.checkAndGetWallet();
        try {
          return yield i.tronWeb.trx.sign(t, n);
        } catch (r) {
          throw r instanceof Error ? new Q(r.message, r) : new Q(r, new Error(r));
        }
      } catch (i) {
        throw this.emit("error", i), i;
      }
  ...
  multiSign(...t) {
    return Y(this, void 0, void 0, function* () {
      try {
        ...
        try {
          return yield n.tronWeb.trx.multiSign(...t);
        } catch (i) {
          throw i instanceof Error ? new Q(i.message, i) : new Q(i, new Error(i));
        }
      } catch (n) {
        throw this.emit("error", n), n;
      }
  ...
  signMessage(t, n) {
    return Y(this, void 0, void 0, function* () {
      try {
        const i = yield this.checkAndGetWallet();
        try {
          return yield i.tronWeb.trx.signMessageV2(t, n);
        } catch (r) {
          throw r instanceof Error ? new Ae(r.message, r) : new Ae(r, new Error(r));
        }
      } catch (i) {
        throw this.emit("error", i), i;
      }
    ...
    return Y(this, void 0, void 0, function* () {
      try {
        ...
        if (!this._supportNewTronProtocol)
          throw new jt("Current version of TronLink doesn't support switch chain operation.");
        ...
        try {
          ...
          throw new jt((i == null ? void 0 : i.message) || i, i instanceof Error ? i : new Error(i));
        }
      } catch (n) {
        throw this.emit("error", n), n;
      }
  ...
  checkAndGetWallet() {
    return Y(this, void 0, void 0, function* () {
      if (this.checkIfOpenTronLink(), yield this._checkWallet(), this.state !== m.Connected)
        throw new U();
  ...
  _listenTronLinkEvent() {
    this._stopListenTronLinkEvent(), window.addEventListener("message", this._tronLinkMessageHandler);
  }
  _stopListenTronLinkEvent() {
    window.removeEventListener("message", this._tronLinkMessageHandler);
  }
  checkIfOpenTronLink() {
    const { dappName: t = "", dappIcon: n = "" } = this.config;
    if (this.config.openTronLinkAppOnMobile !== !1 && ri({ dappIcon: n, dappName: t }))
      throw new de();
  }
  ...
  _listenTronEvent() {
    ...
    const t = this._wallet;
    t.on("chainChanged", this._onChainChanged), t.on("accountsChanged", this._onAccountsChanged);
  }
  _stopListenTronEvent() {
    const t = this._wallet;
    t.removeListener("chainChanged", this._onChainChanged), t.removeListener("accountsChanged", this._onAccountsChanged);
  }
  /**
   ...
   */
  _checkWallet() {
    if (this.readyState === L.Found)
      return Promise.resolve(!0);
    if (this._checkPromise)
      return this._checkPromise;
    const t = 100, n = Math.floor(2e3 / t), i = Math.floor(this.config.checkTimeout / t);
    let r = 0, o;
    return this._checkPromise = new Promise((a) => {
      const l = () => {
        r++;
        const u = r < n && !ce() ? st() : un();
        (u || r > i) && (o && clearInterval(o), this._readyState = u ? L.Found : L.NotFound, this._updateWallet(), this.emit("readyStateChanged", this.readyState), a(u));
      };
      o = setInterval(l, t), l();
    }), this._checkPromise;
  }
  checkForWalletReadyForApp() {
    if (this.checkReadyInterval)
      return;
    let t = 0;
    const n = Math.floor(this.config.checkTimeout / 200), i = () => {
      var r, o;
      (window.tronLink ? !((r = window.tronLink.tronWeb) === null || r === void 0) && r.defaultAddress : !((o = window.tronWeb) === null || o === void 0) && o.defaultAddress) ? (this.checkReadyInterval && clearInterval(this.checkReadyInterval), this.checkReadyInterval = null, this._updateWallet(), this.emit("connect", this.address || "")) : t > n ? (this.checkReadyInterval && clearInterval(this.checkReadyInterval), this.checkReadyInterval = null) : t++;
    };
    this.checkReadyInterval = setInterval(i, 200);
  }
  setAddress(t) {
    this._address = t;
  }
  setState(t) {
    const n = this.state;
    t !== n && (this._state = t, this.emit("stateChanged", t));
  }
}
var li = Object.create, ft = Object.defineProperty, di = Object.getOwnPropertyDescriptor, ui = Object.getOwnPropertyNames, hi = Object.getPrototypeOf, gi = Object.prototype.hasOwnProperty, fi = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), pi = (e, t) => {
  for (var n in t) ft(e, n, { get: t[n], enumerable: !0 });
}, wi = (e, t, n, i) => {
  if (t && typeof t == "object" || typeof t == "function") for (let r of ui(t)) !gi.call(e, r) && r !== n && ft(e, r, { get: () => t[r], enumerable: !(i = di(t, r)) || i.enumerable });
  return e;
}, Ai = (e, t, n) => (n = e != null ? li(hi(e)) : {}, wi(ft(n, "default", { value: e, enumerable: !0 }), e)), vi = fi((e, t) => {
  var n = Object.prototype.hasOwnProperty, i = "~";
  function r() {
  }
  Object.create && (r.prototype = /* @__PURE__ */ Object.create(null), new r().__proto__ || (i = !1));
  function o(s, c, d) {
    this.fn = s, this.context = c, this.once = d || !1;
  }
  function a(s, c, d, p, g) {
    if (typeof d != "function") throw new TypeError("The listener must be a function");
    var w = new o(d, p || s, g), v = i ? i + c : c;
    return s._events[v] ? s._events[v].fn ? s._events[v] = [s._events[v], w] : s._events[v].push(w) : (s._events[v] = w, s._eventsCount++), s;
  }
  function l(s, c) {
  ...
  u.prototype.eventNames = function() {
    var s = [], c, d;
    if (this._eventsCount === 0) return s;
    for (d in c = this._events) n.call(c, d) && s.push(i ? d.slice(1) : d);
    return Object.getOwnPropertySymbols ? s.concat(Object.getOwnPropertySymbols(c)) : s;
  }, u.prototype.listeners = function(s) {
    var c = i ? i + s : s, d = this._events[c];
    if (!d) return [];
    if (d.fn) return [d.fn];
    for (var p = 0, g = d.length, w = new Array(g); p < g; p++) w[p] = d[p].fn;
    return w;
  }, u.prototype.listenerCount = function(s) {
    var c = i ? i + s : s, d = this._events[c];
    return d ? d.fn ? 1 : d.length : 0;
  }, u.prototype.emit = function(s, c, d, p, g, w) {
    var v = i ? i + s : s;
    if (!this._events[v]) return !1;
    var f = this._events[v], y = arguments.length, D, I;
    if (f.fn) {
      ...
      var Ie = f.length, z;
      for (I = 0; I < Ie; I++) switch (f[I].once && this.removeListener(s, f[I].fn, void 0, !0), y) {
        case 1:
          f[I].fn.call(f[I].context);
          break;
        case 2:
...
`, Mi = `<svg width="256" height="256" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Ti({ timeout: e = 1e3, flag: t = "eip1193" } = {}) {
  ...
  function o() {
    if (typeof e != "number") throw new Error("@@bitget-wallet/web3-sdk/detect-provider: Expected option 'timeout' to be a number.");
  }
}
function pt() {
  var e;
  return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test((e = window == null ? void 0 : window.navigator) == null ? void 0 : e.userAgent);
}
function wt() {
  var e;
  return /BitKeep/i.test((e = window == null ? void 0 : window.navigator) == null ? void 0 : e.userAgent);
}
function Si() {
  return !wt() && !pt();
}
...
var mn = function() {
...
}, Pi = Ai(vi()), Oi = Pi.default, zi = class {
  constructor({ debug: t = !1, preferredOpenLink: n, useDeeplink: i = !1 }) {
    this.debug = !1, this.useDeeplink = !1, this.debug = t, this.useDeeplink = i, this.preferredOpenLink = n;
  }
  getLogo(t = "square") {
    return fn(t);
  }
  getWalletInfo() {
    return { logo: this.getLogo(), ...B };
  }
  getDownloadLinks() {
    return B.downloadLinks;
  }
  getDeepLinks() {
    return B.deepLinks;
  }
}, Gi = class extends Oi {
  constructor(t = { providerFlag: "eip1193", isBitkeep: !0, debug: !1 }) {
    super(), this.id = B.id, this.name = B.name, this.version = B.version, this.providerFlag = t.providerFlag, this.isBitkeep = t.isBitkeep, this.platformManager = new zi({});
  }
  getProvider() {
    return Ye(this.providerFlag);
  }
  async getBKWalletInfo() {
    var t, n;
    return window != null && window.selectedAccount ? { id: (t = window == null ? void 0 : window.selectedAccount) == null ? void 0 : t.id, name: (n = window == null ? void 0 : window.selectedAccount) == null ? void 0 : n.name } : null;
  }
  getDeepLinks() {
    return xi();
  }
  ...
  constructor(t = { isBitkeep: !0 }) {
    super({ providerFlag: "tronLink", isBitkeep: t.isBitkeep, debug: t.debug });
  }
  getProvider() {
    return Ye(this.providerFlag);
  }
...
function Fi() {
  if (ce() && !Fe()) {
    const { origin: e, pathname: t, search: n, hash: i } = window.location, r = e + t + n + i;
    return location.href = `https://bkcode.vip?action=dapp&url=${encodeURIComponent(r)}`, !0;
  }
  return !1;
}
...
const Ri = B == null ? void 0 : B.name;
class Wi extends Ze {
  constructor(t = {}) {
    var n;
    super(), this.name = Ri, this.url = B == null ? void 0 : B.homepage, this.icon = (n = B == null ? void 0 : B.logolist) === null || n === void 0 ? void 0 : n.base64, this._readyState = L.Loading, this._state = m.Loading, this.checkReadyInterval = null, this._checkPromise = null, this._updateWallet = () => Z(this, void 0, void 0, function* () {
      var a, l;
      let u = this.state, s = this.address;
      if (Fe()) {
        const c = new Ui();
        this._wallet = (yield c == null ? void 0 : c.getProvider().tronLink) || ((a = window.bitkeep) === null || a === void 0 ? void 0 : a.tronLink), s = ((l = this._wallet.tronWeb.defaultAddress) === null || l === void 0 ? void 0 : l.base58) || null, u = this._wallet.ready ? m.Connected : m.Disconnect, this._wallet.ready || this.checkForWalletReady();
      } else
        this._wallet = null, s = null, u = m.NotFound;
      this.setAddress(s), this.setState(u);
    });
    const { checkTimeout: i = 2 * 1e3, openUrlWhenWalletNotFound: r = !0, openAppWithDeeplink: o = !0 } = t;
    if (typeof i != "number")
      throw new Error("[BitKeepAdapter] config.checkTimeout should be a number");
    if (this.config = {
      checkTimeout: i,
      openUrlWhenWalletNotFound: r,
      openAppWithDeeplink: o
    }, this._connecting = !1, this._wallet = null, this._address = null, !ne()) {
      this._readyState = L.NotFound, this.setState(m.NotFound);
      return;
    }
    Fe() ? (this._readyState = L.Found, this._updateWallet()) : this._checkWallet().then(() => {
      this.connected && this.emit("connect", this.address || "");
    });
  }
  get address() {
    ...
    return Z(this, void 0, void 0, function* () {
      try {
        ...
        if (!t || !t.tronWeb)
          throw new U();
        try {
          return yield hn(t.tronWeb);
        } catch (n) {
          throw new dn(n == null ? void 0 : n.message, n);
        }
      } catch (t) {
    ...
    return Z(this, void 0, void 0, function* () {
      try {
        if (this.checkIfOpenApp(), this.connected || this.connecting)
          return;
        if (yield this._checkWallet(), this.readyState === L.NotFound)
          throw this.config.openUrlWhenWalletNotFound !== !1 && ne() && window.open(this.url, "_blank"), new de();
        ...
        if (!ce()) {
          ...
          this._connecting = !0;
          try {
            yield o.request({ method: "tron_requestAccounts" });
          } catch (l) {
            throw new X(l.message);
          }
        }
        const a = ((t = o.tronWeb.defaultAddress) === null || t === void 0 ? void 0 : t.base58) || ((r = (i = (n = window.bitkeep) === null || n === void 0 ? void 0 : n.tronWeb) === null || i === void 0 ? void 0 : i.defaultAddress) === null || r === void 0 ? void 0 : r.base58) || "";
        this.setAddress(a), this.setState(m.Connected), this.emit("connect", this.address || "");
      } catch (o) {
  ...
  disconnect() {
    return Z(this, void 0, void 0, function* () {
      this.state === m.Connected && (this.setAddress(null), this.setState(m.Disconnect), this.emit("disconnect"));
    });
  }
  signTransaction(t, n) {
    return Z(this, void 0, void 0, function* () {
  ...
  checkAndGetWallet() {
    return Z(this, void 0, void 0, function* () {
      if (this.checkIfOpenApp(), yield this._checkWallet(), !this.connected)
        throw new U();
      const t = this._wallet;
      if (!t || !t.tronWeb)
        throw new U();
  ...
  checkForWalletReady() {
    if (this.checkReadyInterval)
      return;
    let t = 0;
    const n = Math.floor(this.config.checkTimeout / 200), i = () => Z(this, void 0, void 0, function* () {
      this._wallet && this._wallet.ready ? (this.checkReadyInterval && clearInterval(this.checkReadyInterval), this.checkReadyInterval = null, yield this._updateWallet(), this.emit("connect", this.address || "")) : t > n ? (this.checkReadyInterval && clearInterval(this.checkReadyInterval), this.checkReadyInterval = null) : t++;
    });
    this.checkReadyInterval = setInterval(i, 200);
  }
  /**
  ...
  _checkWallet() {
    ...
    if (this._checkPromise)
      return this._checkPromise;
    const t = 100, n = Math.floor(this.config.checkTimeout / t);
    let i = 0, r;
    return this._checkPromise = new Promise((o) => {
      const a = () => {
        i++;
        const l = Fe();
        (l || i > n) && (r && clearInterval(r), this._readyState = l ? L.Found : L.NotFound, this._updateWallet(), this.emit("readyStateChanged", this.readyState), o(l));
      };
      r = setInterval(a, t), a();
    }), this._checkPromise;
  }
  checkIfOpenApp() {
    if (this.config.openAppWithDeeplink !== !1 && Fi())
      throw new de();
  }
  setAddress(t) {
    this._address = t;
...
typeof window < "u" && window.Buffer === void 0 && (window.Buffer = an);
function be(e) {
  const t = [];
  return e.split("/").forEach((i) => {
    let r = parseInt(i, 10);
    isNaN(r) || (i.length > 1 && i[i.length - 1] === "'" && (r += 2147483648), t.push(r));
  }), t;
}
function St(e, t) {
  function n(i, r, o) {
    return i >= r.length ? o : t(r[i], i).then(function(a) {
      return o.push(a), n(i + 1, r, o);
    });
  }
  return Promise.resolve().then(() => n(0, e, []));
}
function Pt(e, t) {
  let n = 0, i = 0, r = t;
  for (; i < 64; ) {
    const o = e[r];
    if (n |= (o & 127) << i, r += 1, !(o & 128))
      return n &= 4294967295, {
        value: n,
        pos: r
      };
...
const Qi = (e) => (e && e.statusCode, e), Je = 4, qe = 1, ge = 224, Hi = 2, Zi = 4, Yi = 5, Xi = 8, Ki = 10, Ji = 6, ke = 250;
class qi {
  constructor(t, n = "TRX") {
    this.transport = t, t.decorateAppAPIMethods(this, [
      "getAddress",
      "getECDHPairKey",
      "signTransaction",
      "signTransactionHash",
   ...
   */
  getAddress(t, n) {
    const i = be(t), r = C.alloc(qe + i.length * Je);
    return r[0] = i.length, i.forEach((o, a) => {
      r.writeUInt32BE(o, 1 + 4 * a);
    }), this.transport.send(ge, Hi, n ? 1 : 0, 0, r).then((o) => {
      const a = o[0], l = o[1 + a];
      return {
        publicKey: o.slice(1, 1 + a).toString("hex"),
        address: o.slice(1 + a + 1, 1 + a + 1 + l).toString("ascii")
      };
    });
  }
  getNextLength(t) {
    const n = Pt(t, 0), i = Pt(t, n.pos);
    return n.value & 7 ? i.value + i.pos : i.pos;
  }
  /**
   ...
   */
  signTransaction(t, n, i) {
    const r = be(t);
    let o = C.from(n, "hex");
    const a = [];
    let l = C.alloc(qe + r.length * Je);
    for (l[0] = r.length, r.forEach((d, p) => {
      l.writeUInt32BE(d, 1 + 4 * p);
    }); o.length > 0; ) {
      const d = this.getNextLength(o);
      if (d > ke)
        throw new Error("Too many bytes to encode.");
      if (l.length + d > ke) {
        a.push(l), l = C.alloc(0);
        continue;
      }
      l = C.concat([l, o.slice(0, d)]), o = o.slice(d, o.length);
    }
    a.push(l);
    const u = [];
    let s;
    ...
    if (a.length === 1)
      ...
      u.push(0);
      for (let d = 1; d < a.length - 1; d += 1)
        d >= c ? u.push(160 | d - c) : u.push(128);
      i !== void 0 && i.length ? u.push(168 | i.length - 1) : u.push(144);
    }
    return St(a, (d, p) => this.transport.send(ge, Zi, u[p], 0, d).then((g) => {
      s = g;
    })).then(() => s.slice(0, 65).toString("hex"), (d) => {
      throw Qi(d);
    });
  }
  /**
   ...
   */
  signTransactionHash(t, n) {
    const i = be(t);
    let r = C.alloc(qe + i.length * Je);
    return r[0] = i.length, i.forEach((o, a) => {
      r.writeUInt32BE(o, 1 + 4 * a);
    }), r = C.concat([r, C.from(n, "hex")]), this.transport.send(ge, Yi, 0, 0, r).then((o) => o.slice(0, 65).toString("hex"));
  }
  /**
   ...
   */
  getAppConfiguration() {
    return this.transport.send(ge, Ji, 0, 0).then((t) => {
      const n = (t[0] & 8) > 0;
      let i = (t[0] & 4) > 0, r = (t[0] & 2) > 0, o = (t[0] & 1) > 0;
      return t[1] === 0 && t[2] === 1 && t[3] < 2 && (o = !0, r = !1), t[1] === 0 && t[2] === 1 && t[3] < 5 && (i = !1), {
        version: `${t[1]}.${t[2]}.${t[3]}`,
        versionN: t[1] * 1e4 + t[2] * 100 + t[3],
        allowData: o,
        allowContract: r,
        truncateAddress: i,
        signByHash: n
   ...
   */
  signPersonalMessage(t, n) {
    const i = be(t), r = C.from(n, "hex");
    let o = 0;
    const a = [], l = r.length.toString(16), u = "00000000".substr(l.length) + l, s = C.concat([C.from(u, "hex"), r]);
    for (; o < s.length; ) {
      const d = o === 0 ? ke - 1 - i.length * 4 : ke, p = o + d > s.length ? s.length - o : d, g = C.alloc(o === 0 ? 1 + i.length * 4 + p : p);
      o === 0 ? (g[0] = i.length, i.forEach((w, v) => {
        g.writeUInt32BE(w, 1 + 4 * v);
      }), s.copy(g, 1 + 4 * i.length, o, o + p)) : s.copy(g, 0, o, o + p), a.push(g), o += p;
    }
    let c;
    return St(a, (d, p) => this.transport.send(ge, Xi, p === 0 ? 0 : 128, 0, d).then((g) => {
      c = g;
    })).then(() => c.slice(0, 65).toString("hex"));
  }
  /**
   * get Tron address for a given BIP 32 path.
   * @param path a path in BIP 32 format
   ...
   */
  getECDHPairKey(t, n) {
    const i = be(t), r = C.from(n, "hex"), o = C.alloc(1 + i.length * 4 + r.length);
    return o[0] = i.length, i.forEach((a, l) => {
      o.writeUInt32BE(a, 1 + 4 * l);
    }), r.copy(o, 1 + 4 * i.length, 0, r.length), this.transport.send(ge, Ki, 0, 1, o).then((a) => a.slice(0, 65).toString("hex"));
  }
}
const In = {}, yn = {}, At = (e, t) => {
  yn[e] = t;
  ...
  class t extends Error {
    constructor(i, r, o) {
      if (super(i || e, o), Object.setPrototypeOf(this, t.prototype), this.name = e, r)
        for (const a in r)
          this[a] = r[a];
      if (o && Vi(o) && "cause" in o && !("cause" in this)) {
        const a = o.cause;
  ...
  if (e && typeof e == "object") {
    try {
      if (typeof e.message == "string") {
        ...
        n.message && n.name && (e = n);
      }
    } catch {
    }
    let t;
    if (typeof e.name == "string") {
      const { name: n } = e, i = yn[n];
      if (i)
        t = i(e);
      else {
        let r = n === "Error" ? Error : In[n];
        r || (r = h(n)), t = Object.create(r.prototype);
        try {
          for (const o in e)
      ...
      typeof e.message == "string" && (t = new Error(e.message));
    return t && !t.stack && Error.captureStackTrace && Error.captureStackTrace(t, bn), t;
  }
  return new Error(String(e));
}, _i = (e) => e && (typeof e == "object" ? Mn(e, []) : typeof e == "function" ? `[Function: ${e.name || "anonymous"}]` : e);
function Mn(e, t) {
  const n = {};
  t.push(e);
  for (const i of Object.keys(e)) {
    ...
    if (typeof r != "function") {
      ...
      if (t.indexOf(e[i]) === -1) {
        n[i] = Mn(e[i], t.slice(0));
        continue;
      }
      n[i] = "[Circular]";
    }
  }
  return typeof e.name == "string" && (n.name = e.name), typeof e.message == "string" && (n.message = e.message), typeof e.stack == "string" && (n.stack = e.stack), n;
}
const $i = h("AccountNameRequired"), er = h("AccountNotSupported"), tr = h("AmountRequired"), nr = h("BluetoothRequired"), ir = h("BtcUnmatchedApp"), rr = h("CantOpenDevice"), or = h("CashAddrNotSupported"), sr = h("ClaimRewardsFeesWarning"), ar = h("CurrencyNotSupported"), cr = h("DeviceAppVerifyNotSupported"), lr = h("DeviceGenuineSocketEarlyClose"), dr = h("DeviceNotGenuine"), ur = h("DeviceOnDashboardExpected"), hr = h("DeviceOnDashboardUnexpected"), gr = h("DeviceInOSUExpected"), fr = h("DeviceHalted"), pr = h("DeviceNameInvalid"), wr = h("DeviceSocketFail"), Ar = h("DeviceSocketNoBulkStatus"), vr = h("DeviceSocketNoBulkStatus"), mr = h("UnresponsiveDeviceError"), Nn = h("DisconnectedDevice"), Cn = h("DisconnectedDeviceDuringOperation"), Ir = h("DeviceExtractOnboardingStateError"), yr = h("DeviceOnboardingStatePollingError"), br = h("EnpointConfig"), Mr = h("EthAppPleaseEnableContractData"), Nr = h("FeeEstimationFailed"), Cr = h("FirmwareNotRecognized"), Er = h("HardResetFail"), Lr = h("InvalidXRPTag"), Dr = h("InvalidAddress"), xr = h("InvalidNonce"), kr = h("InvalidAddressBecauseDestinationIsAlsoSource"), Br = h("LatestMCUInstalledError"), jr = h("UnknownMCU"), Tr = h("LedgerAPIError"), Sr = h("LedgerAPIErrorWithMessage"), Pr = h("LedgerAPINotAvailable"), Or = h("ManagerAppAlreadyInstalled"), zr = h("ManagerAppRelyOnBTC"), Gr = h("ManagerAppDepInstallRequired"), Ur = h("ManagerAppDepUninstallRequired"), Fr = h("ManagerDeviceLocked"), Rr = h("ManagerFirmwareNotEnoughSpace"), Wr = h("ManagerNotEnoughSpace"), Qr = h("ManagerUninstallBTCDep"), Hr = h("NetworkDown"), Zr = h("NetworkError"), Yr = h("NoAddressesFound"), Xr = h("NotEnoughBalance"), Kr = h("NotEnoughBalanceToDelegate"), Jr = h("NotEnoughBalanceInParentAccount"), qr = h("NotEnoughSpendableBalance"), Vr = h("NotEnoughBalanceBecauseDestinationNotCreated"), _r = h("NoAccessToCamera"), $r = h("NotEnoughGas"), eo = h("NotEnoughGasSwap"), to = h("NotSupportedLegacyAddress"), no = h("GasLessThanEstimate"), io = h("PriorityFeeTooLow"), ro = h("PriorityFeeTooHigh"), oo = h("PriorityFeeHigherThanMaxFee"), so = h("MaxFeeTooLow"), ao = h("PasswordsDontMatch"), co = h("PasswordIncorrect"), lo = h("RecommendSubAccountsToEmpty"), uo = h("RecommendUndelegation"), ho = h("TimeoutTagged"), go = h("UnexpectedBootloader"), fo = h("MCUNotGenuineToDashboard"), po = h("RecipientRequired"), wo = h("UnavailableTezosOriginatedAccountReceive"), Ao = h("UnavailableTezosOriginatedAccountSend"), vo = h("UpdateFetchFileFail"), mo = h("UpdateIncorrectHash"), Io = h("UpdateIncorrectSig"), yo = h("UpdateYourApp"), bo = h("UserRefusedDeviceNameChange"), Mo = h("UserRefusedAddress"), No = h("UserRefusedFirmwareUpdate"), Co = h("UserRefusedAllowManager"), Eo = h("UserRefusedOnDevice"), Lo = h("ExpertModeRequired"), at = h("TransportOpenUserCancelled"), Do = h("TransportInterfaceNotAvailable"), En = h("TransportRaceCondition"), xo = h("TransportWebUSBGestureRequired"), ko = h("TransactionHasBeenValidatedError"), Bo = h("TransportExchangeTimeoutError"), jo = h("DeviceShouldStayInApp"), To = h("WebsocketConnectionError"), So = h("WebsocketConnectionFailed"), Po = h("WrongDeviceForAccount"), Oo = h("WrongAppForCurrency"), zo = h("ETHAddressNonEIP"), Go = h("CantScanQRCode"), Uo = h("FeeNotLoaded"), Fo = h("FeeNotLoadedSwap"), Ro = h("FeeRequired"), Wo = h("FeeTooHigh"), Qo = h("PendingOperation"), Ho = h("SyncError"), Zo = h("PairingFailed"), Yo = h("PeerRemovedPairing"), Xo = h("GenuineCheckFailed"), Ko = h("LedgerAPI4xx"), Jo = h("LedgerAPI5xx"), qo = h("FirmwareOrAppUpdateRequired"), Vo = h("ReplacementTransactionUnderpriced"), _o = h("OpReturnSizeLimit"), $o = h("DustLimit"), es = h("LanguageNotFound"), ts = h("NoDBPathGiven"), ns = h("DBWrongPassword"), is = h("DBNotReset");
var ct;
(function(e) {
...
class vt extends Error {
  constructor(t, n) {
    super(n), this.name = "HwTransportError", this.type = t, Object.setPrototypeOf(this, vt.prototype);
  }
}
class le extends Error {
  constructor(t, n) {
    const i = "TransportError";
    super(t || i), this.name = i, this.message = t, this.stack = new Error(t).stack, this.id = n;
  }
}
At("TransportError", (e) => new le(e.message, e.id));
const ue = {
...
class Ee extends Error {
  ...
  constructor(t, { canBeMappedToChildError: n = !0 } = {}) {
    const i = Object.keys(ue).find((l) => ue[l] === t) || "UNKNOWN_ERROR", r = Ln(t) || i, o = t.toString(16), a = `Ledger device: ${r} (0x${o})`;
    if (super(a), this.name = "TransportStatusError", this.statusCode = t, this.statusText = i, n && t === ue.LOCKED_DEVICE)
      return new Dn(a);
  }
}
class Dn extends Ee {
  constructor(t) {
    super(ue.LOCKED_DEVICE, { canBeMappedToChildError: !1 }), t && (this.message = t), this.name = "LockedDeviceError";
  }
}
At("TransportStatusError", (e) => new Ee(e.statusCode));
const rs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AccountNameRequiredError: $i,
  AccountNotSupported: er,
  AmountRequired: tr,
  BluetoothRequired: nr,
  BtcUnmatchedApp: ir,
  CantOpenDevice: rr,
  CantScanQRCode: Go,
  CashAddrNotSupported: or,
  ClaimRewardsFeesWarning: sr,
  CurrencyNotSupported: ar,
  DBNotReset: is,
  DBWrongPassword: ns,
  DeviceAppVerifyNotSupported: cr,
  DeviceExtractOnboardingStateError: Ir,
  DeviceGenuineSocketEarlyClose: lr,
  DeviceHalted: fr,
  DeviceInOSUExpected: gr,
  DeviceNameInvalid: pr,
  DeviceNeedsRestart: vr,
  DeviceNotGenuineError: dr,
  DeviceOnDashboardExpected: ur,
  DeviceOnDashboardUnexpected: hr,
  DeviceOnboardingStatePollingError: yr,
  DeviceShouldStayInApp: jo,
  DeviceSocketFail: wr,
  DeviceSocketNoBulkStatus: Ar,
  DisconnectedDevice: Nn,
  DisconnectedDeviceDuringOperation: Cn,
  DustLimit: $o,
  ETHAddressNonEIP: zo,
  EnpointConfigError: br,
  EthAppPleaseEnableContractData: Mr,
  ExpertModeRequired: Lo,
  FeeEstimationFailed: Nr,
  FeeNotLoaded: Uo,
  FeeNotLoadedSwap: Fo,
  FeeRequired: Ro,
  FeeTooHigh: Wo,
  FirmwareNotRecognized: Cr,
  FirmwareOrAppUpdateRequired: qo,
  GasLessThanEstimate: no,
  GenuineCheckFailed: Xo,
  HardResetFail: Er,
  HwTransportError: vt,
  ...
  InvalidAddress: Dr,
  InvalidAddressBecauseDestinationIsAlsoSource: kr,
  InvalidNonce: xr,
  InvalidXRPTag: Lr,
  LanguageNotFound: es,
  LatestMCUInstalledError: Br,
  LedgerAPI4xx: Ko,
  LedgerAPI5xx: Jo,
  LedgerAPIError: Tr,
  LedgerAPIErrorWithMessage: Sr,
  LedgerAPINotAvailable: Pr,
  LockedDeviceError: Dn,
  MCUNotGenuineToDashboard: fo,
  ManagerAppAlreadyInstalledError: Or,
  ManagerAppDepInstallRequired: Gr,
  ManagerAppDepUninstallRequired: Ur,
  ManagerAppRelyOnBTCError: zr,
  ManagerDeviceLockedError: Fr,
  ManagerFirmwareNotEnoughSpaceError: Rr,
  ManagerNotEnoughSpaceError: Wr,
  ManagerUninstallBTCDep: Qr,
  MaxFeeTooLow: so,
  NetworkDown: Hr,
  NetworkError: Zr,
  NoAccessToCamera: _r,
  ...
  NoDBPathGiven: ts,
  NotEnoughBalance: Xr,
  NotEnoughBalanceBecauseDestinationNotCreated: Vr,
  NotEnoughBalanceInParentAccount: Jr,
  NotEnoughBalanceToDelegate: Kr,
  NotEnoughGas: $r,
  NotEnoughGasSwap: eo,
  NotEnoughSpendableBalance: qr,
  NotSupportedLegacyAddress: to,
  OpReturnDataSizeLimit: _o,
  PairingFailed: Zo,
  PasswordIncorrectError: co,
  PasswordsDontMatchError: ao,
  PeerRemovedPairing: Yo,
  PendingOperation: Qo,
  PriorityFeeHigherThanMaxFee: oo,
  PriorityFeeTooHigh: ro,
  PriorityFeeTooLow: io,
  RecipientRequired: po,
  RecommendSubAccountsToEmpty: lo,
  RecommendUndelegation: uo,
  ReplacementTransactionUnderpriced: Vo,
  StatusCodes: ue,
  SyncError: Ho,
  TimeoutTagged: ho,
  TransactionHasBeenValidatedError: ko,
  TransportError: le,
  TransportExchangeTimeoutError: Bo,
  TransportInterfaceNotAvailable: Do,
  TransportOpenUserCancelled: at,
  TransportRaceCondition: En,
  TransportStatusError: Ee,
  TransportWebUSBGestureRequired: xo,
  UnavailableTezosOriginatedAccountReceive: wo,
  UnavailableTezosOriginatedAccountSend: Ao,
  UnexpectedBootloader: go,
  UnknownMCU: jr,
  UnresponsiveDeviceError: mr,
  UpdateFetchFileFail: vo,
  UpdateIncorrectHash: mo,
  UpdateIncorrectSig: Io,
  UpdateYourApp: yo,
  UserRefusedAddress: Mo,
  UserRefusedAllowManager: Co,
  UserRefusedDeviceNameChange: bo,
  UserRefusedFirmwareUpdate: No,
  UserRefusedOnDevice: Eo,
  WebsocketConnectionError: To,
  WebsocketConnectionFailed: So,
  WrongAppForCurrency: Oo,
  WrongDeviceForAccount: Po,
  addCustomErrorDeserializer: At,
  createCustomErrorClass: h,
  deserializeError: bn,
  getAltStatusMessage: Ln,
  serializeError: _i
...
const os = "transport";
class mt {
  constructor({ context: t, logType: n } = {}) {
    this.exchangeTimeout = 3e4, this.unresponsiveTimeout = 15e3, this.deviceModel = null, this._events = new Yn(), this.send = (i, r, o, a, l = C.alloc(0), u = [ue.OK], { abortTimeoutMs: s } = {}) => Be(this, void 0, void 0, function* () {
      const c = this.tracer.withUpdatedContext({ function: "send" });
      if (l.length >= 256)
        throw c.trace("data.length exceeded 256 bytes limit", { dataLength: l.length }), new le("data.length exceed 256 bytes limit. Got: " + l.length, "DataLengthTooBig");
      c.trace("Starting an exchange", { abortTimeoutMs: s });
      const d = yield this.exchange(
        // The size of the data is added in 1 byte just before `data`
        C.concat([C.from([i, r, o, a]), C.from([l.length]), l]),
        { abortTimeoutMs: s }
      );
      c.trace("Received response from exchange");
      const p = d.readUInt16BE(d.length - 2);
      if (!u.some((g) => g === p))
        throw new Ee(p);
      return d;
    }), this._appAPIlock = null, this.tracer = new Xn(n ?? os, t);
  }
  /**
  ...
  exchangeBulk(t, n) {
    ...
    return Be(this, void 0, void 0, function* () {
      if (!i)
        for (const a of t) {
          const l = yield this.exchange(a);
          if (i)
            return;
          const u = l.readUInt16BE(l.length - 2);
          if (u !== ue.OK)
            throw new Ee(u);
          n.next(l);
        }
    }).then(() => !i && n.complete(), (a) => !i && n.error(a)), { unsubscribe: r };
  }
  /**
   ...
   */
  static create(t = 3e3, n) {
    return new Promise((i, r) => {
      let o = !1;
      const a = this.listen({
        next: (u) => {
          o = !0, a && a.unsubscribe(), l && clearTimeout(l), this.open(u.descriptor, t).then(i, r);
        },
        error: (u) => {
          l && clearTimeout(l), r(u);
        },
        complete: () => {
          l && clearTimeout(l), o || r(new le(this.ErrorMessage_NoDeviceFound, "NoDeviceFound"));
        }
      }), l = n ? setTimeout(() => {
        a.unsubscribe(), r(new le(this.ErrorMessage_ListenTimeout, "ListenTimeout"));
      }, n) : null;
    });
  }
  /**
   ...
   */
  exchangeAtomicImpl(t) {
    return Be(this, void 0, void 0, function* () {
      const n = this.tracer.withUpdatedContext({
        function: "exchangeAtomicImpl",
        unresponsiveTimeout: this.unresponsiveTimeout
      });
      if (this.exchangeBusyPromise)
        throw n.trace("Atomic exchange is already busy"), new En("An action was already pending on the Ledger device. Please deny or reconnect.");
      let i;
      ...
      let o = !1;
      const a = setTimeout(() => {
        n.trace('Timeout reached, emitting Transport event "unresponsive"', {
          unresponsiveTimeout: this.unresponsiveTimeout
        }), o = !0, this.emit("unresponsive");
      }, this.unresponsiveTimeout);
      try {
        const l = yield t();
        return o && (n.trace("Device was unresponsive, emitting responsive"), this.emit("responsive")), l;
      } finally {
        n.trace("Finalize, clearing busy guard"), clearTimeout(a), i && i(), this.exchangeBusyPromise = null;
      }
    });
  }
  decorateAppAPIMethods(t, n, i) {
    for (const r of n)
      t[r] = this.decorateAppAPIMethod(r, t[r], t, i);
  }
  decorateAppAPIMethod(t, n, i, r) {
    return (...o) => Be(this, void 0, void 0, function* () {
      const { _appAPIlock: a } = this;
      if (a)
        return Promise.reject(new le("Ledger Device is busy (lock " + a + ")", "TransportLocked"));
      try {
        return this._appAPIlock = t, this.setScrambleKey(r), yield n.apply(i, o);
      } finally {
   ...
   */
  setTraceContext(t) {
    this.tracer = this.tracer.withContext(t);
  }
  /**
   ...
   */
  updateTraceContext(t) {
    this.tracer.updateContext(t);
  }
  /**
...
mt.ErrorMessage_ListenTimeout = "No Ledger device found (timeout)";
mt.ErrorMessage_NoDeviceFound = "No Ledger device found";
var xn = {};
const ss = /* @__PURE__ */ Gn(rs);
(function(e) {
  e.__esModule = !0;
  var t = ss, n = 5;
  function i(a) {
    var l = C.alloc(2);
    return l.writeUInt16BE(a, 0), l;
  }
  var r = {
    data: C.alloc(0),
    dataLength: 0,
    ...
    return {
      makeBlocks: function(u) {
        var s = C.concat([i(u.length), u]), c = l - 5, d = Math.ceil(s.length / c);
        s = C.concat([
          s,
          C.alloc(d * c - s.length + 1).fill(0)
        ]);
        for (var p = [], g = 0; g < d; g++) {
          var w = C.alloc(5);
          w.writeUInt16BE(a, 0), w.writeUInt8(n, 2), w.writeUInt16BE(g, 3);
          var v = s.slice(g * c, (g + 1) * c);
          p.push(C.concat([w, v]));
        }
        return p;
      },
      reduceResponse: function(u, s) {
        var c = u || r, d = c.data, p = c.dataLength, g = c.sequence;
        if (s.readUInt16BE(0) !== a)
          throw new t.TransportError("Invalid channel", "InvalidChannel");
        if (s.readUInt8(2) !== n)
          throw new t.TransportError("Invalid tag", "InvalidTag");
        if (s.readUInt16BE(3) !== g)
          throw new t.TransportError("Invalid sequence", "InvalidSequence");
        u || (p = s.readUInt16BE(5)), g++;
        var w = s.slice(u ? 5 : 7);
        return d = C.concat([d, w]), d.length > p && (d = d.slice(0, p)), {
          data: d,
          dataLength: p,
          sequence: g
        };
      },
      getReducedResult: function(u) {
        if (u && u.dataLength === u.data.length)
          return u.data;
      }
    };
  };
...
(function(e) {
  e.blue = "blue", e.nanoS = "nanoS", e.nanoSP = "nanoSP", e.nanoX = "nanoX", e.nanoFTS = "nanoFTS";
})(T || (T = {}));
var dt = (re = {}, re[T.blue] = {
  id: T.blue,
  ...
  getBlockSize: function(e) {
    var t;
    return Et.lt((t = Et.coerce(e)) !== null && t !== void 0 ? t : "", "2.0.0") ? 4 * 1024 : 2 * 1024;
  }
}, re[T.nanoSP] = {
  id: T.nanoSP,
...
T.blue, T.nanoS, T.nanoSP, T.nanoX, T.nanoFTS;
var Ot = Object.values(dt), kn = 11415, zt = function(e) {
  var t = Ot.find(function(r) {
    return r.legacyUsbProductId === e;
  });
  if (t)
    return t;
  var n = e >> 8, i = Ot.find(function(r) {
    return r.productIdMM === n;
  });
  return i;
}, cs = [], Gt = {};
for (var ls in dt) {
  var Ut = dt[ls], Ve = Ut.bluetoothSpec;
  if (Ve)
    for (var _e = 0; _e < Ve.length; _e++) {
      var je = Ve[_e];
      cs.push(je.serviceUuid), Gt[je.serviceUuid] = Gt[je.serviceUuid.replace(/-/g, "")] = lt({ deviceModel: Ut }, je);
    }
}
var ds = /* @__PURE__ */ function() {
  ...
  function u(s) {
    ...
    for (; n; ) try {
      if (i = 1, r && (o = s[0] & 2 ? r.return : s[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, s[1])).done) return o;
      switch (r = 0, o && (s = [s[0] & 2, o.value]), s[0]) {
        case 0:
        case 1:
          o = s;
          break;
  ...
  var e = navigator.hid;
  if (!e)
    throw new le("navigator.hid is not supported", "HIDNotSupported");
  return e;
};
function Bn() {
...
function ut() {
  return K(this, void 0, void 0, function() {
    ...
    return J(this, function(t) {
      switch (t.label) {
        case 0:
          return [4, We().getDevices()];
        case 1:
          return e = t.sent(), [2, e.filter(function(n) {
            return n.vendorId === kn;
          })];
      }
    });
  });
    ...
    return J(this, function(n) {
      switch (n.label) {
        case 0:
          return [4, ut()];
        case 1:
          return e = n.sent(), e.length > 0 ? [2, e[0]] : [4, Bn()];
        case 2:
...
var ps = (
  ...
  function(e) {
    ...
    function t(n) {
      ...
      return i.channel = Math.floor(Math.random() * 65535), i.packetSize = 64, i.inputs = [], i.read = function() {
        return i.inputs.length ? Promise.resolve(i.inputs.shift()) : new Promise(function(r) {
          i.inputCallback = r;
        });
      }, i.onInputReport = function(r) {
        var o = C.from(r.data.buffer);
        i.inputCallback ? (i.inputCallback(o), i.inputCallback = null) : i.inputs.push(o);
      }, i._disconnectEmitted = !1, i._emitDisconnect = function(r) {
        i._disconnectEmitted || (i._disconnectEmitted = !0, i.emit("disconnect", r));
      }, i.exchange = function(r) {
              ...
              case 0:
                return [4, this.exchangeAtomicImpl(function() {
                  return K(a, void 0, void 0, function() {
                    var u, s, c, d, p, g, w, v, f;
                    return J(this, function(y) {
                      switch (y.label) {
                        case 0:
                          u = this, s = u.channel, c = u.packetSize, Ct("apdu", "=> " + r.toString("hex")), d = as(s, c), p = d.makeBlocks(r), g = 0, y.label = 1;
                        case 1:
                          return g < p.length ? [4, this.device.sendReport(0, p[g])] : [3, 4];
                        case 2:
                          y.sent(), y.label = 3;
                        case 3:
                          return g++, [3, 1];
                        case 4:
                          return (w = d.getReducedResult(v)) ? [3, 6] : [4, this.read()];
                        case 5:
                          return f = y.sent(), v = d.reduceResponse(v, f), [3, 4];
                        case 6:
                          return Ct("apdu", "<= " + w.toString("hex")), [2, w];
                      }
                    });
                  });
                }).catch(function(u) {
                  throw u && u.message && u.message.includes("write") ? (a._emitDisconnect(u), new Cn(u.message)) : u;
                })];
              case 1:
                return o = l.sent(), [2, o];
            }
      ...
      }, i.device = n, i.deviceModel = typeof n.productId == "number" ? zt(n.productId) : void 0, n.addEventListener("inputreport", i.onInputReport), i;
    }
    return t.request = function() {
      return K(this, void 0, void 0, function() {
        var n, i;
        return J(this, function(r) {
          switch (r.label) {
            case 0:
              return [4, Bn()];
            case 1:
              return n = us.apply(void 0, [r.sent(), 1]), i = n[0], [2, t.open(i)];
          }
        });
      });
        ...
        return J(this, function(i) {
          switch (i.label) {
            case 0:
              return [4, ut()];
            case 1:
              return n = i.sent(), n.length === 0 ? [2, null] : [2, t.open(n[0])];
          }
        });
      });
    }, t.open = function(n) {
        ...
        return J(this, function(o) {
          switch (o.label) {
            case 0:
              return [4, n.open()];
            case 1:
              return o.sent(), i = new t(n), r = function(a) {
                n === a.device && (We().removeEventListener("disconnect", r), i._emitDisconnect(new Nn()));
              }, We().addEventListener("disconnect", r), [2, i];
          }
        });
      });
      ...
      return K(this, void 0, void 0, function() {
        return J(this, function(n) {
          switch (n.label) {
            ...
            case 1:
              return n.sent(), this.device.removeEventListener("inputreport", this.onInputReport), [4, this.device.close()];
            case 2:
              return n.sent(), [
                2
                /*return*/
    ...
    }, t.isSupported = gs, t.list = ut, t.listen = function(n) {
      var i = !1;
      fs().then(function(o) {
        if (!o)
          n.error(new at("Access denied to use Ledger device"));
        else if (!i) {
          var a = typeof o.productId == "number" ? zt(o.productId) : void 0;
          n.next({
            type: "add",
            descriptor: o,
            deviceModel: a
...
function A(e, t, n, i, r, o) {
  var a, l, u = {};
  for (l in t) l == "ref" ? a = t[l] : u[l] = t[l];
  var s = { type: e, props: u, key: n, ref: a, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --ws, __i: -1, __u: 0, __source: r, __self: o };
  if (typeof e == "function" && (a = e.defaultProps)) for (l in a) u[l] === void 0 && (u[l] = a[l]);
  return O.vnode && O.vnode(s), s;
}
function As(e, t) {
...
(Rt.prototype = new Ce()).isPureReactComponent = !0, Rt.prototype.shouldComponentUpdate = function(e, t) {
...
function jn(e, t, n) {
  ...
  }), e.__c.__H = null), (e = As({}, e)).__c != null && (e.__c.__P === n && (e.__c.__P = t), e.__c = null), e.__k = e.__k && e.__k.map(function(i) {
    return jn(i, t, n);
  })), e;
}
function Tn(e, t, n) {
...
O.unmount = function(e) {
...
}, ($e.prototype = new Ce()).__c = function(e, t) {
  var n = t.__c, i = this;
  i.t == null && (i.t = []), i.t.push(n);
  var r = Sn(i.__v), o = !1, a = function() {
  ...
  var l = function() {
    if (!--i.__u) {
      if (i.state.__a) {
        var u = i.state.__a;
        i.__v.__k[0] = Tn(u, u.__c.__P, u.__c.__O);
      }
      var s;
      for (i.setState({ __a: i.__b = null }); s = i.t.pop(); ) s.forceUpdate();
    }
  };
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = jn(this.__b, n, i.__O = i.__P);
    }
    this.__b = null;
  }
  var r = t.__a && Lt(Dt, null, e.fallback);
  return r && (r.__u &= -33), [Lt(Dt, null, t.__a ? null : e.children), r];
};
...
(Te.prototype = new Ce()).__a = function(e) {
  var t = this, n = Sn(t.__v), i = t.o.get(e);
  return i[0]++, function(r) {
    var o = function() {
      t.props.revealOrder ? (i.push(r), Ht(t, e, i)) : r();
    };
    n ? n(o) : o();
  };
...
var ms = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, Is = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, ys = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, bs = /[A-Z0-9]/g, Ms = typeof document < "u", Ns = function(e) {
  return (typeof Symbol < "u" && typeof Symbol() == "symbol" ? /fil|che|rad/ : /fil|che|ra/).test(e);
};
function It(e, t, n) {
  return t.__k == null && (t.textContent = ""), Kn(e, t), typeof n == "function" && n(), e ? e.__c : null;
}
...
O.event = function(e) {
  return Zt && (e = Zt(e)), e.persist = Cs, e.isPropagationStopped = Es, e.isDefaultPrevented = Ls, e.nativeEvent = e;
};
...
O.vnode = function(e) {
  typeof e.type == "string" && function(t) {
    ...
    for (var o in n) {
      var a = n[o];
      if (!(o === "value" && "defaultValue" in n && a == null || Ms && o === "children" && i === "noscript" || o === "class" || o === "className")) {
        var l = o.toLowerCase();
        o === "defaultValue" && "value" in n && n.value == null ? o = "value" : o === "download" && a === !0 ? a = "" : l === "translate" && a === "no" ? a = !1 : l === "ondoubleclick" ? o = "ondblclick" : l !== "onchange" || i !== "input" && i !== "textarea" || Ns(n.type) ? l === "onfocus" ? o = "onfocusin" : l === "onblur" ? o = "onfocusout" : ys.test(o) ? o = l : i.indexOf("-") === -1 && Is.test(o) ? o = o.replace(bs, "-$&").toLowerCase() : a === null && (a = void 0) : l = o = "oninput", l === "oninput" && r[o = l] && (o = "oninputCapture"), r[o] = a;
      }
    }
    i == "select" && r.multiple && Array.isArray(r.value) && (r.value = rt(n.children).forEach(function(u) {
      u.props.selected = r.value.indexOf(u.props.value) != -1;
    })), i == "select" && r.defaultValue != null && (r.value = rt(n.children).forEach(function(u) {
      u.props.selected = r.multiple ? r.defaultValue.indexOf(u.props.value) != -1 : r.defaultValue == u.props.value;
    })), n.class && !n.className ? (r.class = n.class, Object.defineProperty(r, "className", Ds)) : (n.className && !n.class || n.class && n.className) && (r.class = r.className = n.className), t.props = r;
  }(e), e.$$typeof = ms, Yt && Yt(e);
};
var Xt = O.__r;
O.__r = function(e) {
  Xt && Xt(e), e.__c;
...
function me() {
  const t = new URLSearchParams(globalThis.location.search).get("lang"), n = globalThis.localStorage.getItem("lang"), i = (t || n || "").toLowerCase(), r = (globalThis.navigator.language || "").toLowerCase();
  let o;
  ["zh-tw", "zh-hk", "zh-tc"].includes(r) ? o = oe["zh-TC"] : ["zh", "zh-cn"].includes(r) ? o = oe["zh-CN"] : r.includes("en") && (o = oe.en);
  let a = o;
  return i && (["zh-tw", "zh-hk", "zh-tc"].includes(i) ? a = oe["zh-TC"] : ["zh", "zh-cn"].includes(i) ? a = oe["zh-CN"] : i.includes("en") && (a = oe.en)), a || oe.en;
}
function Pn() {
  return A("div", { children: A("img", { style: {
    width: "5vw",
    marginBottom: "1vw"
...
function On() {
  return A("div", Object.assign({ className: "ledger-ant-spin ledger-ant-spin-lg ledger-ant-spin-spinning spin" }, { children: A("span", Object.assign({ className: "ledger-ant-spin-dot" }, { children: [A("i", { className: "ledger-ant-spin-dot-item" }), A("i", { className: "ledger-ant-spin-dot-item" }), A("i", { className: "ledger-ant-spin-dot-item" }), A("i", { className: "ledger-ant-spin-dot-item" })] })) }));
}
function xs(e) {
  const t = gt(() => me(), []);
  return A("div", Object.assign({ style: { textAlign: "center" }, "data-testid": "confirm-content" }, { children: [A(Pn, {}), A("div", Object.assign({ className: "ledger-connecting-pop" }, { children: [A("ul", Object.assign({ className: "ledger-connecting-pop-content" }, { children: [A("li", Object.assign({ className: "title", style: { wordBreak: "break-word" } }, { children: t.checkTitle })), A("li", { children: A("strong", Object.assign({ style: { color: "#B0170D", textAlign: "left", fontWeight: "600" }, "data-testid": "confirm-content-address" }, { children: e.address })) }), A("li", { children: t.checkTip0 }), A("li", { children: t.checkTip1 })] })), A("div", Object.assign({ className: "mt-4" }, { children: [A(On, {}), A("div", { children: A("div", Object.assign({ className: "text-muted" }, { children: A("span", { children: t.confirmTip }) })) })] }))] }))] }));
}
function ks() {
  const e = gt(() => me(), []);
  return A("div", Object.assign({ style: { textAlign: "center" }, "data-testid": "connecting-content" }, { children: [A(Pn, {}), A("div", Object.assign({ className: "ledger-connecting-pop" }, { children: [A("ul", Object.assign({ className: "ledger-connecting-pop-content" }, { children: A("li", Object.assign({ className: "title" }, { children: e.loadingTip0 })) })), A("div", Object.assign({ className: "mt-4" }, { children: [A(On, {}), A("div", { children: A("div", Object.assign({ className: "text-muted" }, { children: A("span", { children: e.loadingTip4 }) })) })] }))] }))] }));
}
function yt(e) {
  return A("div", Object.assign({ className: "ledger-modal-root" }, { children: [A("div", { className: "ledger-modal-mask" }), A("div", Object.assign({ className: "ledger-modal-wrap" }, { children: A("div", Object.assign({ className: "ledger-modal", style: { width: e.width || "550px" } }, { children: A("div", Object.assign({ className: "ledger-modal-content" }, { children: [A("button", Object.assign({ onClick: e.onClose, type: "button", "aria-label": "Close", className: "ledger-modal-close" }, { children: A("span", Object.assign({ className: "ledger-modal-close-x" }, { children: A("i", Object.assign({ "aria-label": "icon: close", className: "icon icon-close ledger-modal-close-icon" }, { children: A("svg", Object.assign({ viewBox: "64 64 896 896", focusable: "false", className: "", "data-icon": "close", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" }, { children: A("path", { d: "M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 0 0 203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z" }) })) })) })) })), A("div", Object.assign({ className: "ledger-modal-header" }, { children: A("div", Object.assign({ className: "ledger-modal-title" }, { children: e.title })) })), A("div", Object.assign({ className: "ledger-modal-body" }, { children: e.children }))] })) })) }))] }));
}
...
function js(e) {
  const [t, n] = Ke(0), [i, r] = Ke([]), [o, a] = Ke(!1), l = Jn(null), u = gt(() => me(), []);
  xt(() => {
    r([...e.accounts]);
  }, [e.accounts]), xt(() => {
    n(e.selectedIndex);
  ...
  function c() {
    const g = i.find((w) => w.index === t);
    e.onConfirm(g || (i == null ? void 0 : i[0]));
  }
  function d() {
    e.onCancel();
  }
  function p() {
    return Bs(this, void 0, void 0, function* () {
      a(!0);
      const g = i[i.length - 1] || { index: -1 }, w = g.index + 1, v = g.index + 6;
      try {
        const f = yield e.getAccounts(w, v);
        r((y) => [...y, ...f]);
      } finally {
        a(!1);
      }
  ...
  return qn(() => {
    var g, w;
    (w = (g = l.current) === null || g === void 0 ? void 0 : g.scrollIntoView) === null || w === void 0 || w.call(g);
  }, [i]), A("div", Object.assign({ style: { paddingLeft: 40 }, className: "ledger-select", "data-testid": "select-account-content" }, { children: [A("span", Object.assign({ className: "title" }, { children: u.selectTip })), A("div", Object.assign({ className: "ledger-select-list-wrap" }, { children: [A("ul", Object.assign({ className: "ledger-select-list", "data-testid": "select-account-list" }, { children: i.map((g, w) => A("li", Object.assign({ className: "ledger-select-item" }, { children: A("label", Object.assign({ htmlFor: `ledger-select-radio${w}` }, { children: [A("input", { className: g.index === t ? "checked" : "", id: `ledger-select-radio${w}`, type: "radio", name: "selectedAddress", value: g.index, checked: g.index === t, onInput: s }), A("span", { children: g.address })] })) }), w)) })), A("div", Object.assign({ style: { display: "flex", justifyContent: "flex-end" } }, { children: A("button", Object.assign({ "data-testid": "btn-load-more", ref: l, style: { marginTop: 10 }, disabled: o, className: "ledger-select-button", onClick: p }, { children: [A("span", Object.assign({ style: { marginRight: o ? 10 : 0 } }, { children: u.loadMore })), o ? (
    /* prettier-ignore */
    A("svg", Object.assign({ width: "18", height: "18", viewBox: "0 0 38 38", xmlns: "http://www.w3.org/2000/svg", stroke: "#fff" }, { children: A("g", Object.assign({ fill: "none", fillRule: "evenodd" }, { children: A("g", Object.assign({ transform: "translate(1 1)", strokeWidth: "2" }, { children: [A("circle", { strokeOpacity: ".5", cx: "18", cy: "18", r: "18" }), A("path", Object.assign({ d: "M36 18c0-9.94-8.06-18-18-18" }, { children: A("animateTransform", { attributeName: "transform", type: "rotate", from: "0 18 18", to: "360 18 18", dur: "1s", repeatCount: "indefinite" }) }))] })) })) }))
  ) : null] })) }))] })), A("footer", Object.assign({ style: { display: "flex", justifyContent: "flex-end" } }, { children: [A("button", Object.assign({ "data-testid": "btn-cancel", style: { marginRight: 10 }, className: "ledger-select-button default-button", onClick: d }, { children: u.cancel })), A("button", Object.assign({ "data-testid": "btn-confirm", disabled: o, className: "ledger-select-button", onClick: c }, { children: u.confirm }))] }))] }));
}
const Ts = `
...
`;
function bt() {
  const e = document.createElement("div"), t = document.createElement("style");
  t.innerHTML = Ts, document.body.append(t), document.body.append(e);
  function n() {
    e.remove(), t.remove();
  }
  return {
...
function Ss() {
  const { onClose: e, div: t } = bt(), n = me();
  return It(A(yt, Object.assign({ title: n.loadingTitle, onClose: e }, { children: A(ks, {}) })), t), e;
}
function Ps(e) {
  const { onClose: t, div: n } = bt(), i = me();
  return It(A(yt, Object.assign({ width: 550, title: i.loadingTitle, onClose: t }, { children: A(xs, { address: e }) })), n), t;
}
function Os(e) {
  const { onClose: t, div: n } = bt(), i = me();
  return new Promise((r, o) => {
    ...
    function l() {
      o(new Error("Operation is canceled.")), t();
    }
    It(A(yt, Object.assign({ title: i.loadingTitle, onClose: l }, { children: A(js, { accounts: e.accounts, selectedIndex: e.selectedIndex || 0, onConfirm: a, onCancel: l, getAccounts: e.getAccounts }) })), n);
  });
}
...
const Gs = function({ accounts: e, ledgerUtils: t }) {
  return R(this, void 0, void 0, function* () {
    const n = yield Os({
      accounts: e,
...
class Us {
  constructor(t = {}) {
    this.app = null, this.transport = null, this.fetchState = "Initial", this.selectedIndex = 0, this._address = "", this.getAccounts = (i, r) => R(this, void 0, void 0, function* () {
      if (i < 0)
      ...
      if (this.fetchState === "Fetching")
        return yield Jt(500), this.getAccounts(i, r);
      this.fetchState = "Fetching", yield this.makeApp();
      try {
        const o = {};
        for (let a = i; a < r; a++) {
          const l = yield this.getAccount(a);
          o[l.index] = l;
        }
        return Object.keys(o).forEach((a) => {
          this.accounts[+a] = o[a];
        }), this.accounts.slice(i, r);
      } finally {
        this.fetchState = "Initial", yield this.cleanUp();
      }
    }), this.getAddress = (i, r = !1) => R(this, void 0, void 0, function* () {
      try {
        const o = this.getPathForIndex(i);
        return yield this.makeApp(), yield this.app.getAddress(o, r);
      } finally {
        yield this.cleanUp();
      }
    }), this.accounts = [];
    const { accountNumber: n = 1 } = t;
    if (["beforeConnect", "selectAccount", "getDerivationPath"].forEach((i) => {
      if (t[i] && !zs(t[i]))
        throw new Error(`[Ledger]: ${i} must be a function!`);
    }), n && !Number.isInteger(+n))
      throw new Error("[Ledger]: accountNumber must be an integer!");
    this.config = Object.assign(Object.assign({}, t), { accountNumber: n });
  }
  get address() {
    return this._address;
  }
  connect(t) {
    return R(this, void 0, void 0, function* () {
      if (t != null && t.account && typeof t.account == "object") {
        const l = t.account;
        this.selectedIndex = +l.index, this._address = l.address, l.index === void 0 || l.address;
        return;
      }
      const n = {
      ...
      this.accounts = [], this._address = "", this.selectedIndex = 0;
      const { accountNumber: i = 1, beforeConnect: r, selectAccount: o = Gs } = this.config;
      let a = null;
      try {
        r ? yield r() : a = Ss(), yield this.makeApp();
        const l = yield this.getAccount(0);
        this.accounts[0] = l, yield this.cleanUp(), i > 1 && (yield this.getAccounts(1, i)), a == null || a();
        const u = this.accounts.slice(0, i), s = yield o({
          accounts: u,
          ledgerUtils: n
        });
        this.selectedIndex = s.index, this._address = s.address;
      } finally {
        yield this.cleanUp();
      }
    });
  ...
  disconnect() {
    this.selectedIndex = 0, this._address = "";
  }
  signPersonalMessage(t) {
    return R(this, void 0, void 0, function* () {
      ...
      try {
        ...
        yield this.makeApp();
        const i = this.getPathForIndex(n), r = C.from(t).toString("hex");
        return yield this.app.signPersonalMessage(i, r);
      } finally {
        yield this.cleanUp();
      }
    });
  ...
  signTransaction(t) {
    return R(this, void 0, void 0, function* () {
      yield this.waitForIdle();
      try {
        const n = this.selectedIndex, i = this.getPathForIndex(n);
        yield this.makeApp();
        let r;
        try {
          r = yield this.app.signTransaction(i, t.raw_data_hex, []);
        } catch (o) {
          if (/Too many bytes to encode/.test(o.message))
            r = yield this.app.signTransactionHash(i, t.txID);
          else
            throw o;
        }
  ...
  getAccount(t) {
    return R(this, void 0, void 0, function* () {
      const n = this.getPathForIndex(t), { address: i } = yield this.app.getAddress(n);
      return {
        path: n,
        address: i,
        index: t
  ...
  waitForIdle() {
    return R(this, void 0, void 0, function* () {
      this.fetchState === "Fetching" && (yield Jt(300), yield this.waitForIdle());
    });
  }
  getPathForIndex(t) {
  ...
  makeApp() {
    return R(this, void 0, void 0, function* () {
      this.transport && this.app || (this.transport = yield ps.create(), this.app = new qi(this.transport));
    });
  }
  cleanUp() {
    var t;
    return R(this, void 0, void 0, function* () {
      this.app = null, yield (t = this.transport) === null || t === void 0 ? void 0 : t.close(), this.transport = null;
    });
  }
}
...
const Fs = () => !!(globalThis.navigator && globalThis.navigator.hid), Rs = "Ledger";
class Ws extends Ze {
  constructor(t = {}) {
    super(), this.name = Rs, this.url = "https://www.ledger.com/", this.icon = "data:image/png;base64,", this._readyState = L.Loading, this._state = m.NotFound, this._connecting = !1, this._address = null, this.config = t, this._wallet = new Us(t), Fs() ? (this._readyState = L.Found, this._state = m.Disconnect) : this._readyState = L.NotFound;
  }
  get address() {
    return this._address;
  }
    ...
    return Se(this, void 0, void 0, function* () {
      try {
        if (this.connected || this.connecting)
          return;
        if (this.state === m.NotFound)
          throw this.config.openUrlWhenWalletNotFound !== !1 && ne() && window.open(this.url, "_blank"), new de();
        this._connecting = !0;
        try {
          yield this._wallet.connect(t);
        } catch (n) {
          throw new X(`${n.message}.`);
        }
        this._address = this._wallet.address, this._state = m.Connected, this.emit("connect", this.address || ""), this.emit("stateChanged", this._state);
      } catch (n) {
        throw this.emit("error", n), n;
      } finally {
        this._connecting = !1;
  ...
  disconnect() {
    return Se(this, void 0, void 0, function* () {
      if (this.state === m.Connected)
        try {
          this._wallet.disconnect(), this._state = m.Disconnect, this._address = null, this.emit("disconnect"), this.emit("stateChanged", this._state);
        } catch (t) {
          throw this.emit("error", t), new ln(t.message);
        }
    });
  }
  signTransaction(t) {
    ...
    return Se(this, void 0, void 0, function* () {
      try {
        ...
        try {
          ...
          throw new Ae(n == null ? void 0 : n.message, n);
        }
      } catch (n) {
        throw this.emit("error", n), n;
      }
...
const Qe = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1 }, et = (e) => typeof e == "object" && e !== null, te = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakSet(), Qs = (e = Object.is, t = (s, c) => new Proxy(s, c), n = (s) => et(s) && !Pe.has(s) && (Array.isArray(s) || !(Symbol.iterator in s)) && !(s instanceof WeakMap) && !(s instanceof WeakSet) && !(s instanceof Error) && !(s instanceof Number) && !(s instanceof Date) && !(s instanceof String) && !(s instanceof RegExp) && !(s instanceof ArrayBuffer), i = (s) => {
  switch (s.status) {
    case "fulfilled":
      return s.value;
    case "rejected":
  ...
  const p = r.get(s);
  if ((p == null ? void 0 : p[0]) === c)
    return p[1];
  const g = Array.isArray(s) ? [] : Object.create(Object.getPrototypeOf(s));
  return kt(g, !0), r.set(s, [c, g]), Reflect.ownKeys(s).forEach((w) => {
    if (Object.getOwnPropertyDescriptor(g, w))
      return;
    const v = Reflect.get(s, w), f = {
      value: v,
      enumerable: !0,
  ...
  if (c)
    return c;
  let d = l[0];
  const p = /* @__PURE__ */ new Set(), g = (N, M = ++l[0]) => {
    d !== M && (d = M, p.forEach((b) => b(N, M)));
  };
  let w = l[1];
  const v = (N = ++l[1]) => (w !== N && !p.size && (w = N, y.forEach(([M]) => {
    const b = M[1](N);
    b > d && (d = b);
  })), d), f = (N) => (M, b) => {
    const G = [...M];
    G[1] = [N, ...G[1]], g(G, b);
  }, y = /* @__PURE__ */ new Map(), D = (N, M) => {
    if ((Qe && "production") !== "production" && y.has(N))
    ...
    var M;
    const b = y.get(N);
    b && (y.delete(N), (M = b[1]) == null || M.call(b));
  }, Ie = (N) => (p.add(N), p.size === 1 && y.forEach(([b, G], he) => {
    if ((Qe && "production") !== "production" && G)
      throw new Error("remove already exists");
    const ye = b[3](f(he));
    y.set(he, [b, ye]);
  }), () => {
    p.delete(N), p.size === 0 && y.forEach(([b, G], he) => {
      G && (G(), y.set(he, [b]));
    });
  }), z = Array.isArray(s) ? [] : Object.create(Object.getPrototypeOf(s)), Le = t(z, {
    deleteProperty(N, M) {
      const b = Reflect.get(N, M);
      I(M);
      const G = Reflect.deleteProperty(N, M);
      return G && g(["delete", [M], b]), G;
    },
    set(N, M, b, G) {
      const he = Reflect.has(N, M), ye = Reflect.get(N, M, G);
      if (he && (e(ye, b) || a.has(b) && e(ye, a.get(b))))
        return !0;
      I(M), et(b) && (b = Vn(b) || b);
      let De = b;
      if (b instanceof Promise)
        b.then(($) => {
          b.status = "fulfilled", b.value = $, g(["resolve", [M], $]);
        }).catch(($) => {
          b.status = "rejected", b.reason = $, g(["reject", [M], $]);
        });
      else {
        !te.has(b) && n(b) && (De = u(b));
        const $ = !Pe.has(De) && te.get(De);
        $ && D(M, $);
      }
      return Reflect.set(N, M, De, G), g(["set", [M], b, ye]), !0;
    }
  });
  a.set(s, Le);
  const zn = [
  ...
  return te.set(Le, zn), Reflect.ownKeys(s).forEach((N) => {
    const M = Object.getOwnPropertyDescriptor(
      s,
      N
    );
    "value" in M && (Le[N] = s[N], delete M.value, delete M.writable), Object.defineProperty(z, N, M);
  }), Le;
}) => [
  // public functions
  u,
...
function _(e, t, n) {
  ...
  let l = !1;
  const s = a((c) => {
    o.push(c), r || (r = Promise.resolve().then(() => {
      r = void 0, l && t(o.splice(0));
    }));
  });
  return l = !0, () => {
    l = !1, s();
...
function Zs(e, t) {
  const n = te.get(e), [i, r, o] = n;
  return o(i, r(), t);
}
let tt;
const q = { ethereumClient: void 0, setEthereumClient(e) {
  tt = e;
}, client() {
  if (tt) return tt;
  throw new Error("ClientCtrl has no client set");
} }, x = H({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }), ae = { state: x, subscribe(e) {
  return _(x, () => e(x));
}, push(e, t) {
  e !== x.view && (x.view = e, t && (x.data = t), x.history.push(e));
}, reset(e) {
  x.view = e, x.history = [e];
}, replace(e) {
  x.history.length > 1 && (x.history[x.history.length - 1] = e, x.view = e);
}, goBack() {
  if (x.history.length > 1) {
    x.history.pop();
    const [e] = x.history.slice(-1);
    x.view = e;
  }
}, setData(e) {
  x.data = e;
} }, S = { WALLETCONNECT_DEEPLINK_CHOICE: "WALLETCONNECT_DEEPLINK_CHOICE", W3M_VERSION: "W3M_VERSION", W3M_PREFER_INJECTED_URL_FLAG: "w3mPreferInjected", RECOMMENDED_WALLET_AMOUNT: 9, isMobile() {
  return typeof window < "u" ? !!(window.matchMedia("(pointer:coarse)").matches || /Android|webOS|iPhone|iPad|iPod|BlackBerry|Opera Mini/u.test(navigator.userAgent)) : !1;
}, isAndroid() {
  return S.isMobile() && navigator.userAgent.toLowerCase().includes("android");
}, isIos() {
  const e = navigator.userAgent.toLowerCase();
  return S.isMobile() && (e.includes("iphone") || e.includes("ipad"));
}, isHttpUrl(e) {
  return e.startsWith("http://") || e.startsWith("https://");
}, isArray(e) {
  return Array.isArray(e) && e.length > 0;
}, formatNativeUrl(e, t, n) {
  if (S.isHttpUrl(e)) return this.formatUniversalUrl(e, t, n);
  let i = e;
  i.includes("://") || (i = e.replaceAll("/", "").replaceAll(":", ""), i = `${i}://`), this.setWalletConnectDeepLink(i, n);
  const r = encodeURIComponent(t);
  return `${i}wc?uri=${r}`;
}, formatUniversalUrl(e, t, n) {
  if (!S.isHttpUrl(e)) return this.formatNativeUrl(e, t, n);
  let i = e;
  e.endsWith("/") && (i = e.slice(0, -1)), this.setWalletConnectDeepLink(i, n);
  const r = encodeURIComponent(t);
  return `${i}/wc?uri=${r}`;
}, async wait(e) {
  return new Promise((t) => {
  ...
  localStorage.setItem(S.WALLETCONNECT_DEEPLINK_CHOICE, JSON.stringify({ href: e, name: t }));
}, setWalletConnectAndroidDeepLink(e) {
  const [t] = e.split("?");
  localStorage.setItem(S.WALLETCONNECT_DEEPLINK_CHOICE, JSON.stringify({ href: t, name: "Android" }));
}, removeWalletConnectDeepLink() {
  localStorage.removeItem(S.WALLETCONNECT_DEEPLINK_CHOICE);
}, setWeb3ModalVersionInStorage() {
  typeof localStorage < "u" && localStorage.setItem(S.W3M_VERSION, "2.4.2");
}, getWalletRouterData() {
  var e;
  const t = (e = ae.state.data) == null ? void 0 : e.Wallet;
  if (!t) throw new Error('Missing "Wallet" view data');
  return t;
}, getSwitchNetworkRouterData() {
  var e;
  const t = (e = ae.state.data) == null ? void 0 : e.SwitchNetwork;
  if (!t) throw new Error('Missing "SwitchNetwork" view data');
  return t;
}, isPreferInjectedFlag() {
  return typeof location < "u" ? new URLSearchParams(location.search).has(S.W3M_PREFER_INJECTED_URL_FLAG) : !1;
} }, Ys = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")), P = H({ enabled: Ys, userSessionId: "", events: [], connectedWalletId: void 0 }), Xs = { state: P, subscribe(e) {
  return _(P.events, () => e(Zs(P.events[P.events.length - 1])));
}, initialize() {
  P.enabled && typeof crypto < "u" && (P.userSessionId = crypto.randomUUID());
}, setConnectedWalletId(e) {
  P.connectedWalletId = e;
}, click(e) {
  if (P.enabled) {
    const t = { type: "CLICK", name: e.name, userSessionId: P.userSessionId, timestamp: Date.now(), data: e };
    P.events.push(t);
  }
}, track(e) {
  if (P.enabled) {
    const t = { type: "TRACK", name: e.name, userSessionId: P.userSessionId, timestamp: Date.now(), data: e };
    P.events.push(t);
  }
}, view(e) {
  if (P.enabled) {
    const t = { type: "VIEW", name: e.name, userSessionId: P.userSessionId, timestamp: Date.now(), data: e };
    P.events.push(t);
  }
} }, j = H({ selectedChain: void 0, chains: void 0, standaloneChains: void 0, standaloneUri: void 0, isStandalone: !1, isAuth: !1, isCustomDesktop: !1, isCustomMobile: !1, isDataLoaded: !1, isUiLoaded: !1, isPreferInjected: !1, walletConnectVersion: 1 }), k = { state: j, subscribe(e) {
  return _(j, () => e(j));
}, setChains(e) {
  j.chains = e;
}, setStandaloneChains(e) {
  j.standaloneChains = e;
}, setStandaloneUri(e) {
  j.standaloneUri = e;
}, getSelectedChain() {
  const e = q.client().getNetwork().chain;
  return e && (j.selectedChain = e), j.selectedChain;
}, setSelectedChain(e) {
  j.selectedChain = e;
}, setIsStandalone(e) {
  j.isStandalone = e;
  ...
  j.walletConnectVersion = e;
}, setIsPreferInjected(e) {
  j.isPreferInjected = e;
}, setIsAuth(e) {
  j.isAuth = e;
} }, Oe = H({ projectId: "", mobileWallets: void 0, desktopWallets: void 0, walletImages: void 0, chainImages: void 0, tokenImages: void 0, tokenContracts: void 0, standaloneChains: void 0, enableStandaloneMode: !1, enableAuthMode: !1, enableNetworkView: !1, enableAccountView: !0, enableExplorer: !0, defaultChain: void 0, explorerExcludedWalletIds: void 0, explorerRecommendedWalletIds: void 0, termsOfServiceUrl: void 0, privacyPolicyUrl: void 0 }), ie = { state: Oe, subscribe(e) {
  return _(Oe, () => e(Oe));
}, setConfig(e) {
  var t, n, i, r;
  Xs.initialize(), k.setStandaloneChains(e.standaloneChains), k.setIsStandalone(!!((t = e.standaloneChains) != null && t.length) || !!e.enableStandaloneMode), k.setIsAuth(!!e.enableAuthMode), k.setIsCustomMobile(!!((n = e.mobileWallets) != null && n.length)), k.setIsCustomDesktop(!!((i = e.desktopWallets) != null && i.length)), k.setWalletConnectVersion((r = e.walletConnectVersion) != null ? r : 1), k.state.isStandalone || (k.setChains(q.client().chains), k.setIsPreferInjected(q.client().isInjectedProviderInstalled() && S.isPreferInjectedFlag())), e.defaultChain && k.setSelectedChain(e.defaultChain), S.setWeb3ModalVersionInStorage(), Object.assign(Oe, e);
} }, E = H({ address: void 0, profileName: void 0, profileAvatar: void 0, profileLoading: !1, balanceLoading: !1, balance: void 0, isConnected: !1 }), Ks = { state: E, subscribe(e) {
  return _(E, () => e(E));
}, getAccount() {
  const e = q.client().getAccount();
  E.address = e.address, E.isConnected = e.isConnected;
}, async fetchProfile(e, t) {
  var n;
  try {
    E.profileLoading = !0;
    const i = t ?? E.address, r = (n = k.state.chains) == null ? void 0 : n.find((o) => o.id === 1);
    if (i && r) {
      const o = await q.client().fetchEnsName({ address: i, chainId: 1 });
      if (o) {
        const a = await q.client().fetchEnsAvatar({ name: o, chainId: 1 });
        a && await e(a), E.profileAvatar = a;
      }
      E.profileName = o;
    }
  } finally {
  ...
  try {
    const { chain: t } = q.client().getNetwork(), { tokenContracts: n } = ie.state;
    let i;
    t && n && (i = n[t.id]), E.balanceLoading = !0;
    const r = e ?? E.address;
    if (r) {
      const o = await q.client().fetchBalance({ address: r, token: i });
      E.balance = { amount: o.formatted, symbol: o.symbol };
    }
  } finally {
    E.balanceLoading = !1;
  }
  ...
  E.address = void 0, E.isConnected = !1, E.profileName = void 0, E.profileAvatar = void 0, E.balance = void 0;
} }, ht = "https://explorer-api.walletconnect.com";
async function ze(e, t) {
  const n = new URL(e, ht);
  return n.searchParams.append("projectId", ie.state.projectId), Object.entries(t).forEach(([i, r]) => {
    r && n.searchParams.append(i, String(r));
  }), (await fetch(n)).json();
}
const ee = { async getDesktopListings(e) {
  return ze("/w3m/v1/getDesktopListings", e);
}, async getMobileListings(e) {
  return ze("/w3m/v1/getMobileListings", e);
}, async getInjectedListings(e) {
  return ze("/w3m/v1/getInjectedListings", e);
}, async getAllListings(e) {
  return ze("/w3m/v1/getAllListings", e);
}, getWalletImageUrl(e) {
  return `${ht}/w3m/v1/getWalletImage/${e}?projectId=${ie.state.projectId}`;
}, getAssetImageUrl(e) {
  return `${ht}/w3m/v1/getAssetImage/${e}?projectId=${ie.state.projectId}`;
} };
var Js = Object.defineProperty, qt = Object.getOwnPropertySymbols, qs = Object.prototype.hasOwnProperty, Vs = Object.prototype.propertyIsEnumerable, Vt = (e, t, n) => t in e ? Js(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, _s = (e, t) => {
  for (var n in t || (t = {})) qs.call(t, n) && Vt(e, n, t[n]);
  if (qt) for (var n of qt(t)) Vs.call(t, n) && Vt(e, n, t[n]);
  return e;
};
const _t = S.isMobile(), F = H({ wallets: { listings: [], total: 0, page: 1 }, injectedWallets: [], search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), Ca = { state: F, async getRecomendedWallets() {
  const { explorerRecommendedWalletIds: e, explorerExcludedWalletIds: t } = ie.state;
  if (e === "NONE" || t === "ALL" && !e) return F.recomendedWallets;
  if (S.isArray(e)) {
    const n = { recommendedIds: e.join(",") }, { listings: i } = await ee.getAllListings(n), r = Object.values(i);
    r.sort((o, a) => {
      const l = e.indexOf(o.id), u = e.indexOf(a.id);
      return l - u;
    }), F.recomendedWallets = r;
  } else {
    const { standaloneChains: n, walletConnectVersion: i, isAuth: r } = k.state, o = n == null ? void 0 : n.join(","), a = S.isArray(t), l = { page: 1, sdks: r ? "auth_v1" : void 0, entries: S.RECOMMENDED_WALLET_AMOUNT, chains: o, version: i, excludedIds: a ? t.join(",") : void 0 }, { listings: u } = _t ? await ee.getMobileListings(l) : await ee.getDesktopListings(l);
    F.recomendedWallets = Object.values(u);
  }
  return F.recomendedWallets;
}, async getWallets(e) {
  const t = _s({}, e), { explorerRecommendedWalletIds: n, explorerExcludedWalletIds: i } = ie.state, { recomendedWallets: r } = F;
  if (i === "ALL") return F.wallets;
  t.search || (r.length ? t.excludedIds = r.map((d) => d.id).join(",") : S.isArray(n) && (t.excludedIds = n.join(","))), S.isArray(i) && (t.excludedIds = [t.excludedIds, i].filter(Boolean).join(",")), k.state.isAuth && (t.sdks = "auth_v1");
  const { page: o, search: a } = e, { listings: l, total: u } = _t ? await ee.getMobileListings(t) : await ee.getDesktopListings(t), s = Object.values(l), c = a ? "search" : "wallets";
  return F[c] = { listings: [...F[c].listings, ...s], total: u, page: o ?? 1 }, { listings: s, total: u };
}, async getInjectedWallets() {
  const { listings: e } = await ee.getInjectedListings({}), t = Object.values(e);
  return F.injectedWallets = t, F.injectedWallets;
}, getWalletImageUrl(e) {
  return ee.getWalletImageUrl(e);
}, getAssetImageUrl(e) {
  return ee.getAssetImageUrl(e);
}, resetSearch() {
  F.search = { listings: [], total: 0, page: 1 };
} }, Me = H({ pairingUri: "", pairingError: !1 }), $t = { state: Me, subscribe(e) {
  return _(Me, () => e(Me));
}, setPairingUri(e) {
  Me.pairingUri = e;
}, setPairingError(e) {
  Me.pairingError = e;
} }, fe = H({ open: !1 }), nt = { state: fe, subscribe(e) {
  return _(fe, () => e(fe));
}, async open(e) {
  return new Promise((t) => {
    const { isStandalone: n, isUiLoaded: i, isDataLoaded: r, isPreferInjected: o, selectedChain: a } = k.state, { isConnected: l } = Ks.state, { enableNetworkView: u } = ie.state;
    if (n) k.setStandaloneUri(e == null ? void 0 : e.uri), k.setStandaloneChains(e == null ? void 0 : e.standaloneChains), ae.reset("ConnectWallet");
    else if (e != null && e.route) ae.reset(e.route);
    else if (l) ae.reset("Account");
    else if (u) ae.reset("SelectNetwork");
    else if (o) {
      q.client().connectConnector("injected", a == null ? void 0 : a.id).catch((c) => {
      }), t();
      return;
    } else ae.reset("ConnectWallet");
    const { pairingUri: s } = $t.state;
    if (i && r && (n || s || l)) fe.open = !0, t();
    else {
      const c = setInterval(() => {
        const d = k.state, p = $t.state;
        d.isUiLoaded && d.isDataLoaded && (d.isStandalone || p.pairingUri || l) && (clearInterval(c), fe.open = !0, t());
      }, 200);
    }
  });
}, close() {
...
var $s = Object.defineProperty, en = Object.getOwnPropertySymbols, ea = Object.prototype.hasOwnProperty, ta = Object.prototype.propertyIsEnumerable, tn = (e, t, n) => t in e ? $s(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, na = (e, t) => {
  for (var n in t || (t = {})) ea.call(t, n) && tn(e, n, t[n]);
  if (en) for (var n of en(t)) ta.call(t, n) && tn(e, n, t[n]);
  return e;
};
function ia() {
  return typeof matchMedia < "u" && matchMedia("(prefers-color-scheme: dark)").matches;
}
const Ne = H({ themeMode: ia() ? "dark" : "light" }), nn = { state: Ne, subscribe(e) {
  return _(Ne, () => e(Ne));
}, setThemeConfig(e) {
  const { themeMode: t, themeVariables: n } = e;
  t && (Ne.themeMode = t), n && (Ne.themeVariables = na({}, n));
} }, se = H({ open: !1, message: "", variant: "success" }), Ea = { state: se, subscribe(e) {
  return _(se, () => e(se));
}, openToast(e, t) {
  se.open = !0, se.message = e, se.variant = t;
}, closeToast() {
  se.open = !1;
} };
typeof window < "u" && (window.Buffer || (window.Buffer = an), window.global || (window.global = window), window.process || (window.process = { env: {} }));
var ra = Object.defineProperty, rn = Object.getOwnPropertySymbols, oa = Object.prototype.hasOwnProperty, sa = Object.prototype.propertyIsEnumerable, on = (e, t, n) => t in e ? ra(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, aa = (e, t) => {
  for (var n in t || (t = {})) oa.call(t, n) && on(e, n, t[n]);
  if (rn) for (var n of rn(t)) sa.call(t, n) && on(e, n, t[n]);
  return e;
};
class ca {
  constructor(t) {
    this.openModal = nt.open, this.closeModal = nt.close, this.subscribeModal = nt.subscribe, this.setTheme = nn.setThemeConfig, nn.setThemeConfig(t), ie.setConfig(aa({ enableStandaloneMode: !0 }, t)), this.initUi();
  }
  async initUi() {
    if (typeof window < "u") {
      await import("./index.es-BD5tzXtf.js");
      const t = document.createElement("w3m-modal");
      document.body.insertAdjacentElement("beforeend", t), k.setIsUiLoaded(!0);
    }
  }
}
class pe extends Error {
  constructor() {
    super(), Object.setPrototypeOf(this, pe.prototype);
  }
}
...
var He;
(function(e) {
  e.Mainnet = "tron:0x2b6653dc", e.Shasta = "tron:0x94a9059e", e.Nile = "tron:0xcd8690dc";
})(He || (He = {}));
var ve;
(function(e) {
  e.signTransaction = "tron_signTransaction", e.signMessage = "tron_signMessage";
})(ve || (ve = {}));
const it = (e, t) => ({
  requiredNamespaces: {
    tron: {
      chains: [e],
      methods: [ve.signTransaction, ve.signMessage],
      events: []
    }
  },
  pairingTopic: t
...
class la {
  constructor(t) {
    this._options = t.options, this._network = t.network, this._web3ModalConfig = t.web3ModalConfig || {}, this.web3Modal = new ca({
  ...
  async connect() {
    const t = this._client ?? await Bt.init(this._options), n = t.find(it(this._network)).filter((i) => i.acknowledged);
    if (n.length) {
      this._session = n[n.length - 1], this._client = t, this._client = t;
      const i = Object.values(this._session.namespaces).map((r) => r.accounts).flat();
      return this.address = i[0].split(":")[2], {
        address: this.address
      };
    } else {
      const { uri: i, approval: r } = await t.connect(it(this._network));
      return new Promise((o, a) => {
        i && (this.web3Modal.openModal({
          uri: i,
          standaloneChains: [this._network],
          route: "ConnectWallet"
        }), this.web3Modal.subscribeModal((l) => {
          l.open === !1 && a(new Mt("Modal is closed."));
        })), r().then((l) => {
          this._session = l, this._client = t;
          const u = Object.values(this._session.namespaces).map((s) => s.accounts).flat();
          this.address = u[0].split(":")[2], o({ address: this.address });
        }).catch(a).finally(() => {
  ...
  async checkConnectStatus() {
    const t = this._client ?? await Bt.init(this._options), n = t.find(it(this._network)).filter((i) => i.acknowledged);
    if (n.length) {
      this._session = n[n.length - 1], this._client = t;
      const i = Object.values(this._session.namespaces).map((r) => r.accounts).flat();
      return this.address = i[0].split(":")[2], {
        address: this.address
      };
  ...
  async signTransaction(t) {
    if (this._client && this._session) {
      const { result: n } = await this._client.request({
        chainId: this._network,
        topic: this._session.topic,
        request: {
          method: ve.signTransaction,
          params: {
            address: this.address,
            transaction: { ...t }
          }
...
class ha extends Ze {
  ...
  connect() {
    return Ge(this, void 0, void 0, function* () {
      try {
        ...
        try {
          t = new la({
            network: He[this._config.network] || He.Nile,
            options: this._config.options,
            web3ModalConfig: this._config.web3ModalConfig
          }), { address: n } = yield t.connect();
        } catch (i) {
          throw i.constructor.name === "Web3ModalError" ? new ti() : new X(i == null ? void 0 : i.message, i);
        }
        t.client.on("session_delete", this._disconnected), this._wallet = t, this._address = n || "", this._state = m.Connected, this.emit("stateChanged", this._state), this.emit("connect", n);
      } catch (t) {
        throw this.emit("error", t), t;
      } finally {
        this._connecting = !1;
  ...
  disconnect() {
    return Ge(this, void 0, void 0, function* () {
      ...
      const t = this._wallet;
      if (t) {
        t.client.off("session_delete", this._disconnected), this._wallet = null, this._address = null;
        try {
          yield t.disconnect();
        } catch (n) {
          this.emit("error", new ln(n == null ? void 0 : n.message, n));
        }
      }
      this._state = m.Disconnect, this.emit("disconnect"), this.emit("stateChanged", this._state);
    });
  }
  signTransaction(t) {
    return Ge(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (!n)
          throw new U();
        try {
          return yield n.signTransaction({ transaction: t });
        } catch (i) {
          throw new Q(i == null ? void 0 : i.message, i);
        }
      } catch (n) {
        throw this.emit("error", n), n;
      }
    ...
    return Ge(this, void 0, void 0, function* () {
      try {
        ...
        try {
          ...
          throw new Ae(i == null ? void 0 : i.message, i);
        }
      } catch (n) {
        throw this.emit("error", n), n;
      }
...
const Ue = ({
  ...
  name: W[t].name,
  type: W[t].type,
  signTransaction: e.signTransaction.bind(e),
  connect: async () => (i.emitter.emit("message", { type: "connecting" }), await e.connect(), Nt("sk-widget@1//shimDisconnect/tron", !0), {
    accounts: [e.address],
    chainId: xe.id
  }),
  disconnect: () => (Nt("sk-widget@1//shimDisconnect/tron", !1), e.disconnect()),
  getAccounts: async () => (await Rn.liftEither(
    Wn.fromNullable([e.address]).toEither(
      new Error("No account found")
    )
  )).unsafeCoerce(),
  switchChain: async () => xe,
  getChainId: async () => xe.id,
  isAuthorized: async () => Qn("sk-widget@1//shimDisconnect/tron").map((r) => !!(r && e.connected && e.address)).orDefault(!1),
  onAccountsChanged: (r) => {
    r.length === 0 ? i.emitter.emit("disconnect") : i.emitter.emit("change", { accounts: r });
  },
  onChainChanged: (r) => {
    i.emitter.emit("change", { chainId: r });
  },
  onDisconnect: () => {
    i.emitter.emit("disconnect");
  },
  getProvider: async () => ({}),
  $filteredChains: new Hn([xe]).asObservable()
})), ga = ({
  forceWalletConnectOnly: e
}) => {
  const t = () => ({
    id: W.tronWc.id,
    name: W.tronWc.name,
    ...
    createConnector: (n) => Ue({
      ...
      adapter: new ha({
        ...
        options: {
          ...
          projectId: Zn.walletConnectV2.projectId
        },
        web3ModalConfig: {
  ...
  return {
    ...
    wallets: e ? [t] : [
      ...
      () => ({
        id: W.tronLedger.id,
        name: W.tronLedger.name,
        iconUrl: Xe.ledgerLogo,
        iconBackground: "#fff",
        createConnector: (n) => Ue({
          walletDetailsParams: n,
...
//# sourceMappingURL=tron-connector-BEAC20Pu.js.map
