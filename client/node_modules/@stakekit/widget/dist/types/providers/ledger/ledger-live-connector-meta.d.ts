...
import type { WalletAPIClient, deserializeTransaction } from "@ledgerhq/wallet-api-client";
...
export declare const configMeta: {
    id: string;
    name: string;
    type: string;
};
...
export declare const isLedgerLiveConnector: (connector: Connector) => connector is LedgerLiveConnector;
export {};
