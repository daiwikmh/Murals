import type { ActionTypes, TokenDto, YieldBalanceDto, YieldDto } from "@stakekit/api-hooks";
...
export type BalanceTokenActionType = `${YieldBalanceDto["type"]}-${TokenString}-${ActionTypes}`;
export type PendingActionAmountChange = Action<"pendingAction/amount/change", {
    balanceType: YieldBalanceDto["type"];
    token: TokenDto;
    actionType: ActionTypes;
    amount: BigNumber;
}>;
export type Actions = UnstakeAmountChange | UnstakeAmountMax | PendingActionAmountChange;
export type State = {
